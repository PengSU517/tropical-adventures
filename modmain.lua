...
-- modimport("scripts/map/forest_map")


-- modimport("postinit/map/node")
-- AddClassPostConstruct("map/node", function(self)
-- 	local NodeAddEntity = self.AddEntity

-- 	self.AddEntity = function(self, prefab, points_x, points_y, current_pos_idx, entitiesOut, width, height, prefab_list,
