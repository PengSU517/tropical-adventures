...
local StoreWidget = Class(Widget, function(self, owner, goods)
    ...
    self.image = self:AddChild(Image("images/inventoryimages.xml", prefabname .. ".tex", "default.tex")) and
        self:AddChild(Image("images/inventoryimages/hamletinventory.xml", prefabname .. ".tex", "default.tex")) and
        ...
        -- self:AddChild(Image("images/tfwp_inventoryimgs.xml", prefabname .. ".tex", "default.tex")) and
        self:AddChild(Image("images/inventoryimages/volcanoinventory.xml", prefabname .. ".tex", "default.tex"))
