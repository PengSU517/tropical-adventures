require "class"
require "util"
CustomPrefab = Class(Prefab,
    function(self, a, b, c, d, e, f, g, h, i, j)
        Prefab._ctor(self, a, b, c, d, e)
        self.name = a; self.atlas = f and resolvefilepath(f) or resolvefilepath("images/inventoryimages.xml")
