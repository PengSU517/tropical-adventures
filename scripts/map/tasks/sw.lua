...
--     room_tags = { "RoadPoison", "shipwrecked", "tropical", "nohunt", "nohasslers", "not_mainland" },
--     room_choices = {
...
AddTask("Volcano ground", {
    ...
    keys_given = { KEYS.MEDIUM },
    region_id = "volcano",
    room_tags = { "RoadPoison", "volcano", "shipwrecked", "tropical", "nohunt", "nohasslers", "not_mainland" },
    room_choices = {
