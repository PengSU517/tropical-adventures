...
local states =
{
        ...
        timeline =
        {
            TimeEvent(3 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/enemy/scorpion/walk")
            end),
            TimeEvent(3 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/enemy/scorpion/mumble")
            end),
        },
    ...
    State {
        ...
        timeline =
        {
            TimeEvent(5 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/enemy/scorpion/claw")
            end),
            TimeEvent(6 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/enemy/scorpion/claw")
            ...
            TimeEvent(10 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/enemy/scorpion/attack_grunt")
            end),
    ...
    State {
        ...
        onenter = function(inst, target)
            if inst.components.poisonous then
        ...
        timeline =
        {
            TimeEvent(20 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/enemy/scorpion/tail_attack")
            end),
            ...
            TimeEvent(20 * FRAMES, function(inst)
                inst.components.combat:SetRange(SCORPION_STING_RANGE, SCORPION_STING_RANGE)
    ...
    State {
        ...
        timeline =
        {
            ...
            TimeEvent(8 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/enemy/scorpion/tail_attack_pre")
            end),
