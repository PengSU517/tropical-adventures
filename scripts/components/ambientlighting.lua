...
return Class(function(self, inst)
    ...
    local function PushCurrentColour()
        ...
        elseif _flashstate <= 1 then
            ...
            TheSim:SetAmbientColour(_realcolour.currentcolour.x * _realcolour.lightpercent * _flashcolour,
                _realcolour.currentcolour.y * _realcolour.lightpercent * _flashcolour,
                _realcolour.currentcolour.z * _realcolour.lightpercent * _flashcolour)
            TheSim:SetVisualAmbientColour(_overridecolour.currentcolour.x * _overridecolour.lightpercent * _flashcolour,
                _overridecolour.currentcolour.y * _overridecolour.lightpercent * _flashcolour,
                _overridecolour.currentcolour.z * _overridecolour.lightpercent * _flashcolour)
        end
    end
    ...
    local function ComputeTargetColour(targetsettings, timeoverride)
        local col = _overridefixedcolour
            ...
            or
            (targetsettings.currentcolourset.PHASE_COLOURS[_season] and targetsettings.currentcolourset.PHASE_COLOURS[_season][_phase])
    ...
    function self:GetVisualAmbientValue()
        return (_flashstate == 1 and _flashcolour)
            or
            (_flashstate <= 0 and _overridecolour.lightpercent or _overridecolour.lightpercent * _flashcolour) *
            (_overridecolour.currentcolour.x + _overridecolour.currentcolour.y + _overridecolour.currentcolour.z) / 3
    end
