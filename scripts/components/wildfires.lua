...
return Class(function(self, inst)
    ...
    local function CheckValidWildfireStarter(obj)
        local casa = GetClosestInstWithTag("blows_air", obj, 20)                                                                   -------------------------------adicionado
        if casa then return false end                                                                                              -----------------------------------------------------------adicionado
        local jogador = GetClosestInstWithTag("player", obj, 20)
        if jogador and jogador.components.areaaware and jogador.components.areaaware:CurrentlyInTag("frost") then return false end -----------------------------------------------------------adicionado
        local x, y, z = obj.Transform:GetWorldPosition()
