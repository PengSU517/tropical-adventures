...
tropical_adventrues_prefabs_path = tropical_adventrues_root_path + r"\scripts\components"

dst_prefabs_path = dst_path + r"\components"
...
for file_name in intersection_files:
    ...
    # 构造新文件名，添加前缀'TA_'
    new_file_name = 'tropical_' + file_name
    ...
    # 构造新文件名，添加前缀'TA_'
    dst_new_file_name = 'tropical_' + file_name
