...
--BAT CAVE
    ...
    Prefab("deco_cave_pillar_side",
        decofn("interior_wall_decals_batcave", "interior_wall_decals_cave", "pillar_sidewall", { decal = true }), assets,
        prefabs),
    ...
    Prefab("deco_cave_stalactite", decofn("interior_wall_decals_batcave", "interior_wall_decals_cave", "stalactite"),
        assets, prefabs),
    ...
    Prefab("deco_hive_cornerbeam",
        decofn("interior_wall_decals_antcave", "interior_wall_decals_antcave", "pillar_corner",
            { decal = true, background = 3, tags = { "cornerpost" } }), assets, prefabs),
    Prefab("deco_hive_pillar_side",
        decofn("interior_wall_decals_antcave", "interior_wall_decals_antcave", "pillar_sidewall", { decal = true }),
        assets, prefabs),
    Prefab("deco_hive_floor_trim", decofn("interior_wall_decals_antcave", "interior_wall_decals_antcave", "floor_trim_1"),
        assets, prefabs),
    ...
    Prefab("deco_hive_broken_pillar",
        decofn("interior_wall_decals_antcave", "interior_wall_decals_antcave", "pillar_broken"), assets, prefabs),
    ...
    -- PIG RUINS
    Prefab("deco_ruins_crack_roots1",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "hole_1", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_ruins_crack_roots2",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "hole_2", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_ruins_crack_roots3",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "roots_1", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_ruins_crack_roots4",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "roots_2", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_ruins_roots1",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "vines_1", { decal = true, background = 2 }),
        assets, prefabs),
    Prefab("deco_ruins_roots2",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "vines_2", { decal = true, background = 2 }),
        assets, prefabs),
    Prefab("deco_ruins_roots3",
    ...
    Prefab("deco_ruins_cornerbeam",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "pillar_corner",
            { decal = true, background = 3, tags = { "cornerpost" } }), assets, prefabs),
    Prefab("deco_ruins_cornerbeam_heavy",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "pillar_corner_lg",
            { decal = true, background = 3, tags = { "cornerpost" } }), assets, prefabs),
    ...
    Prefab("deco_ruins_wallstrut",
        ...
        prefabs),
    Prefab("deco_ruins_walltorch",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "sconce_metal_sidewall",
            { decal = true, background = 3 }), assets, prefabs),
    ...
    Prefab("deco_ruins_pigqueen_relief_blue",
        decofn("interior_wall_decals_ruins_blue", "interior_wall_decals_ruins", "relief_queen",
            { decal = true, background = 1 }), assets, prefabs),
    Prefab("deco_ruins_pigman_relief1_blue",
        decofn("interior_wall_decals_ruins_blue", "interior_wall_decals_ruins", "relief_confused",
            { decal = true, background = 1 }), assets, prefabs),
    Prefab("deco_ruins_pigman_relief3_blue",
        decofn("interior_wall_decals_ruins_blue", "interior_wall_decals_ruins", "relief_surprise",
            { decal = true, background = 1 }), assets, prefabs),
    Prefab("deco_ruins_pigman_relief_side_blue",
    ...
    Prefab("deco_ruins_cornerbeam_blue",
        decofn("interior_wall_decals_ruins_blue", "interior_wall_decals_ruins", "pillar_corner",
            { decal = true, background = 3, tags = { "cornerpost" } }), assets, prefabs),
    Prefab("deco_ruins_cornerbeam_heavy_blue",
        decofn("interior_wall_decals_ruins_blue", "interior_wall_decals_ruins", "pillar_corner_lg",
            { decal = true, background = 3, tags = { "cornerpost" } }), assets, prefabs),
    Prefab("deco_ruins_beam_heavy_blue",
        decofn("interior_wall_decals_ruins_blue", "interior_wall_decals_ruins", "pillar_side_lg",
            { decal = true, background = 3 }), assets, prefabs),
    Prefab("deco_ruins_beam_blue",
        decofn("interior_wall_decals_ruins_blue", "interior_wall_decals_ruins", "pillar_front", { decal = true }), assets,
        prefabs),
