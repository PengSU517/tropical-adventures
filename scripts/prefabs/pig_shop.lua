...
return
    ...
    makeshop("pig_shop_hoofspa", "pig_shop_hoofspa", nil,
        { indestructable = true, sounds = { SHOPSOUND_ENTER1, SHOPSOUND_ENTER2 } }),
    makeshop("pig_shop_produce", "pig_shop_produce", nil,
        { indestructable = true, sounds = { SHOPSOUND_ENTER1, SHOPSOUND_ENTER2 } }),
    makeshop("pig_shop_florist", "pig_shop_florist", nil,
        { indestructable = true, sounds = { SHOPSOUND_ENTER1, SHOPSOUND_ENTER2 } }),
    makeshop("pig_shop_antiquities", "pig_shop_antiquities", nil,
        { indestructable = true, sounds = { SHOPSOUND_ENTER1, SHOPSOUND_ENTER2 } }),
    makeshop("pig_shop_academy", "pig_shop_accademia", nil,
        { indestructable = true, sounds = { SHOPSOUND_ENTER1, SHOPSOUND_ENTER2 } }),
    makeshop("pig_shop_arcane", "pig_shop_arcane", nil,
        { indestructable = true, sounds = { SHOPSOUND_ENTER1, SHOPSOUND_ENTER2 } }),
    makeshop("pig_shop_weapons", "pig_shop_weapons", nil,
        { indestructable = true, sounds = { SHOPSOUND_ENTER1, SHOPSOUND_ENTER2 } }),
