if
    TUNING.tropical.multiplayerportal == 5 and TUNING.tropical.kindofworld == 15 or
    TUNING.tropical.multiplayerportal == 15 and TUNING.tropical.kindofworld == 15 or
    TUNING.tropical.kindofworld == 5 or
    TUNING.tropical.kindofworld == 20 then
    local assets =
    {
    ...
    local function MakePortal2(name, bank, build, assets, prefabs, common_postinit, master_postinit)
        local function fn()
            ...
            if TUNING.tropical.multiplayerportal == 5 and TUNING.tropical.kindofworld == 15 or TUNING.tropical.kindofworld == 20 then
                inst.AnimState:SetBank("portal_dst")
                inst.AnimState:SetBuild("portal_stone")
                inst.AnimState:PlayAnimation("idle_loop", true)
            end
    ...
    return MakePortal2("multiplayer_portal", "portal_dst", "portal_stone", assets, nil, stone_common_postinit),
        MakePortal("multiplayer_portal_moonrock_constr", "portal_construction_dst", "portal_stone", assets_construction,
            prefabs_construction, construction_common_postinit, construction_master_postinit),
        MakePortal("multiplayer_portal_moonrock", "portal_moonrock_dst", "portal_moonrock", assets_moonrock,
