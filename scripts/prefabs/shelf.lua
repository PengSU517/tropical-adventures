...
local function OnTimerDonebonestaff(inst, data)
    if data.name == "spawndelay" then
        local pote = SpawnPrefab("shelves_bonestaff")
        pote.Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function OnTimerDonebossboar(inst, data)
    if data.name == "spawndelay" then
        local pote = SpawnPrefab("shelves_bossboar")
        pote.Transform:SetPosition(inst.Transform:GetWorldPosition())
