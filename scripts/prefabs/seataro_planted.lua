...
local function fn(Sim)
	...
	inst.components.pickable:SetUp("seataro", TUNING.SAPLING_REGROW_TIME)
...
local function fn1(Sim)
	...
	inst.components.cookable.product = "seataro_cooked"
...
return Prefab("common/inventory/seataro_planted", fn, assets),
	Prefab("seataro_cooked", fn2, assets),
	Prefab("seataro", fn1, assets, prefabs)
