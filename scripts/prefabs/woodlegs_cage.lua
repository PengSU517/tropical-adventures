...
local function ItemGet(inst, giver, item)
	if inst.collectedKeys[item.prefab] ~= nil then
		...
		if item.prefab == "woodlegs_key1" then
			inst.SoundEmitter:PlaySound("dontstarve_DLC002/characters/woodlegs/key_1", "key1")
		elseif item.prefab == "woodlegs_key2" then
			inst.SoundEmitter:PlaySound("dontstarve_DLC002/characters/woodlegs/key_2", "key2")
		else
			inst.SoundEmitter:PlaySound("dontstarve_DLC002/characters/woodlegs/key_3", "key3")
		end
		TestForUnlock(inst)
	end
end
...
local function fn(Sim)
	...
	minimap:SetIcon("woodlegs_cage.tex")
