...
local function SetAnim(inst)
	...
	elseif left then
		inst.Transform:SetPosition(ex - 0.5 * TILE_SCALE * math.cos(bearing - 0.5 * PI), ey,
			ez - 0.5 * TILE_SCALE * math.sin(bearing - 0.5 * PI))
...
return Prefab("wave_shore_tropical", fn, assets)
