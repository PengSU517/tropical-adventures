...
print(vagner[18].numexits)
        ...
        if inst.tipodemaze == 5 then
            ...
            if vagner[1].numexits > 0 then
                ...
                vagner[1].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima + 7, 0,
                    TheWorld.components.contador:GetZ())
                ---------
                if vagner[1].baixo ~= nil then
                    vagner[1].saidabaixo = SpawnPrefab("roc_cave_door_baixo")
                    vagner[1].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                end
                --------------
                if vagner[1].esquerda ~= nil then
                    vagner[1].saidaesquerda = SpawnPrefab("roc_cave_door_esquerda")
                    vagner[1].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                end
                --------------------
                if vagner[1].direita ~= nil then
                    vagner[1].saidadireita = SpawnPrefab("roc_cave_door_direita")
                    vagner[1].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
                end
            ...
            if vagner[2].numexits > 0 then
                ...
                if vagner[2].cima ~= nil then
                    ...
                    vagner[2].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[2].baixo ~= nil then
                    ...
                    vagner[2].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[2].esquerda ~= nil then
                    ...
                    vagner[2].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[2].direita ~= nil then
                    ...
                    vagner[2].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[3].numexits > 0 then
                ...
                if vagner[3].cima ~= nil then
                    ...
                    vagner[3].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[3].baixo ~= nil then
                    ...
                    vagner[3].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[3].esquerda ~= nil then
                    ...
                    vagner[3].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[3].direita ~= nil then
                    ...
                    vagner[3].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[4].numexits > 0 then
                ...
                if vagner[4].cima ~= nil then
                    ...
                    vagner[4].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[4].baixo ~= nil then
                    ...
                    vagner[4].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[4].esquerda ~= nil then
                    ...
                    vagner[4].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[4].direita ~= nil then
                    ...
                    vagner[4].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[5].numexits > 0 then
                ...
                if vagner[5].cima ~= nil then
                    ...
                    vagner[5].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[5].baixo ~= nil then
                    ...
                    vagner[5].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[5].esquerda ~= nil then
                    ...
                    vagner[5].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[5].direita ~= nil then
                    ...
                    vagner[5].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[6].numexits > 0 then
                ...
                if vagner[6].cima ~= nil then
                    ...
                    vagner[6].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[6].baixo ~= nil then
                    ...
                    vagner[6].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[6].esquerda ~= nil then
                    ...
                    vagner[6].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[6].direita ~= nil then
                    ...
                    vagner[6].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
        ...
        if inst.tipodemaze == 6 then
            ...
            if vagner[7].numexits > 0 then
                ...
                if vagner[7].cima ~= nil then
                    ...
                    vagner[7].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[7].baixo ~= nil then
                    ...
                    vagner[7].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[7].esquerda ~= nil then
                    ...
                    vagner[7].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[7].direita ~= nil then
                    ...
                    vagner[7].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[8].numexits > 0 then
                ...
                if vagner[8].cima ~= nil then
                    ...
                    vagner[8].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[8].baixo ~= nil then
                    ...
                    vagner[8].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[8].esquerda ~= nil then
                    ...
                    vagner[8].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[8].direita ~= nil then
                    ...
                    vagner[8].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[9].numexits > 0 then
                ...
                if vagner[9].cima ~= nil then
                    ...
                    vagner[9].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[9].baixo ~= nil then
                    ...
                    vagner[9].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[9].esquerda ~= nil then
                    ...
                    vagner[9].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[9].direita ~= nil then
                    ...
                    vagner[9].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[10].numexits > 0 then
                ...
                if vagner[10].cima ~= nil then
                    ...
                    vagner[10].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[10].baixo ~= nil then
                    ...
                    vagner[10].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[10].esquerda ~= nil then
                    ...
                    vagner[10].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[10].direita ~= nil then
                    ...
                    vagner[10].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[11].numexits > 0 then
                ...
                if vagner[11].cima ~= nil then
                    ...
                    vagner[11].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[11].baixo ~= nil then
                    ...
                    vagner[11].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[11].esquerda ~= nil then
                    ...
                    vagner[11].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[11].direita ~= nil then
                    ...
                    vagner[11].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[12].numexits > 0 then
                ...
                if vagner[12].cima ~= nil then
                    ...
                    vagner[12].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[12].baixo ~= nil then
                    ...
                    vagner[12].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[12].esquerda ~= nil then
                    ...
                    vagner[12].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[12].direita ~= nil then
                    ...
                    vagner[12].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[13].numexits > 0 then
                ...
                if vagner[13].cima ~= nil then
                    ...
                    vagner[13].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[13].baixo ~= nil then
                    ...
                    vagner[13].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[13].esquerda ~= nil then
                    ...
                    vagner[13].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[13].direita ~= nil then
                    ...
                    vagner[13].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[14].numexits > 0 then
                ...
                if vagner[14].cima ~= nil then
                    ...
                    vagner[14].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[14].baixo ~= nil then
                    ...
                    vagner[14].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[14].esquerda ~= nil then
                    ...
                    vagner[14].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[14].direita ~= nil then
                    ...
                    vagner[14].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[15].numexits > 0 then
                ...
                if vagner[15].cima ~= nil then
                    ...
                    vagner[15].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[15].baixo ~= nil then
                    ...
                    vagner[15].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[15].esquerda ~= nil then
                    ...
                    vagner[15].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[15].direita ~= nil then
                    ...
                    vagner[15].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[16].numexits > 0 then
                ...
                if vagner[16].cima ~= nil then
                    ...
                    vagner[16].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[16].baixo ~= nil then
                    ...
                    vagner[16].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[16].esquerda ~= nil then
                    ...
                    vagner[16].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[16].direita ~= nil then
                    ...
                    vagner[16].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[17].numexits > 0 then
                ...
                if vagner[17].cima ~= nil then
                    ...
                    vagner[17].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[17].baixo ~= nil then
                    ...
                    vagner[17].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[17].esquerda ~= nil then
                    ...
                    vagner[17].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[17].direita ~= nil then
                    ...
                    vagner[17].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[18].numexits > 0 then
                ...
                if vagner[18].cima ~= nil then
                    ...
                    vagner[18].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[18].baixo ~= nil then
                    ...
                    vagner[18].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[18].esquerda ~= nil then
                    ...
                    vagner[18].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[18].direita ~= nil then
                    ...
                    vagner[18].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[19].numexits > 0 then
                ...
                if vagner[19].cima ~= nil then
                    ...
                    vagner[19].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[19].baixo ~= nil then
                    ...
                    vagner[19].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[19].esquerda ~= nil then
                    ...
                    vagner[19].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[19].direita ~= nil then
                    ...
                    vagner[19].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[20].numexits > 0 then
                ...
                if vagner[20].cima ~= nil then
                    ...
                    vagner[20].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[20].baixo ~= nil then
                    ...
                    vagner[20].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[20].esquerda ~= nil then
                    ...
                    vagner[20].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[20].direita ~= nil then
                    ...
                    vagner[20].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[21].numexits > 0 then
                ...
                if vagner[21].cima ~= nil then
                    ...
                    vagner[21].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[21].baixo ~= nil then
                    ...
                    vagner[21].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[21].esquerda ~= nil then
                    ...
                    vagner[21].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[21].direita ~= nil then
                    ...
                    vagner[21].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[22].numexits > 0 then
                ...
                if vagner[22].cima ~= nil then
                    ...
                    vagner[22].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[22].baixo ~= nil then
                    ...
                    vagner[22].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[22].esquerda ~= nil then
                    ...
                    vagner[22].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[22].direita ~= nil then
                    ...
                    vagner[22].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[23].numexits > 0 then
                ...
                if vagner[23].cima ~= nil then
                    ...
                    vagner[23].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[23].baixo ~= nil then
                    ...
                    vagner[23].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[23].esquerda ~= nil then
                    ...
                    vagner[23].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[23].direita ~= nil then
                    ...
                    vagner[23].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[24].numexits > 0 then
                ...
                if vagner[24].cima ~= nil then
                    ...
                    vagner[24].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[24].baixo ~= nil then
                    ...
                    vagner[24].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[24].esquerda ~= nil then
                    ...
                    vagner[24].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[24].direita ~= nil then
                    ...
                    vagner[24].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
        ...
        if inst.tipodemaze < 5 or inst.tipodemaze == 8 or inst.tipodemaze == 9 then
            ...
            if vagner[2].numexits > 0 then
                if inst.saladotesouso == vagner[2].nome then
                    if inst.prefab == "maze_pig_ruins_entrance" then
                        SpawnPrefab("createtreasurerelictruffle")
                    elseif inst.prefab == "maze_pig_ruins_entrance2" then
                        SpawnPrefab("createtreasurerelicsow")
                    elseif inst.prefab == "maze_pig_ruins_entrance3" then
                        SpawnPrefab("createpheromonestoneroom")
            ...
            if vagner[25].numexits > 0 then
                ...
                if vagner[25].cima ~= nil then
                    ...
                    vagner[25].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[25].baixo ~= nil then
                    ...
                    vagner[25].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[25].esquerda ~= nil then
                    ...
                    vagner[25].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[25].direita ~= nil then
                    ...
                    vagner[25].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[26].numexits > 0 then
                ...
                if vagner[26].cima ~= nil then
                    ...
                    vagner[26].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[26].baixo ~= nil then
                    ...
                    vagner[26].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[26].esquerda ~= nil then
                    ...
                    vagner[26].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[26].direita ~= nil then
                    ...
                    vagner[26].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[27].numexits > 0 then
                ...
                if vagner[27].cima ~= nil then
                    ...
                    vagner[27].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[27].baixo ~= nil then
                    ...
                    vagner[27].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[27].esquerda ~= nil then
                    ...
                    vagner[27].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[27].direita ~= nil then
                    ...
                    vagner[27].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[28].numexits > 0 then
                ...
                if vagner[28].cima ~= nil then
                    ...
                    vagner[28].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[28].baixo ~= nil then
                    ...
                    vagner[28].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[28].esquerda ~= nil then
                    ...
                    vagner[28].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[28].direita ~= nil then
                    ...
                    vagner[28].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[29].numexits > 0 then
                ...
                if vagner[29].cima ~= nil then
                    ...
                    vagner[29].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[29].baixo ~= nil then
                    ...
                    vagner[29].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[29].esquerda ~= nil then
                    ...
                    vagner[29].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[29].direita ~= nil then
                    ...
                    vagner[29].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
            ...
            if vagner[30].numexits > 0 then
                ...
                if vagner[30].cima ~= nil then
                    ...
                    vagner[30].saidacima.Transform:SetPosition(TheWorld.components.contador:GetX() + distportacima, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[30].baixo ~= nil then
                    ...
                    vagner[30].saidabaixo.Transform:SetPosition(TheWorld.components.contador:GetX() + distportabaixo, 0,
                        TheWorld.components.contador:GetZ())
                ...
                if vagner[30].esquerda ~= nil then
                    ...
                    vagner[30].saidaesquerda.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportaesquerda)
                ...
                if vagner[30].direita ~= nil then
                    ...
                    vagner[30].saidadireita.Transform:SetPosition(TheWorld.components.contador:GetX(), 0,
                        TheWorld.components.contador:GetZ() + distportadireita)
        ...
        if inst.tipodemaze == 6 then
            ...
            vagner[saidadolabirinto1].saidacima.Transform:SetPosition(vagner[saidadolabirinto1].valorx + distportacima, 0,
                vagner[saidadolabirinto1].valorz)
