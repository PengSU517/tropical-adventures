...
local function entrance()
	...
	if inst.entrada == nil then
		...
		inst.exit = SpawnPrefab("pig_shop_produce_door_saida")
		...
		----------------parede do fundo---------------------------------------------
		local part = SpawnPrefab("wallinteriorproduce")
		if part ~= nil then
		...
		if part ~= nil then
			part.Transform:SetPosition(x + 10 / 6 + 1, 0, z + 15 / 6 + 1)
			part.Transform:SetRotation(95)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		local part = SpawnPrefab("rug_rectangle")
		if part ~= nil then
			part.Transform:SetPosition(x + 10 / 6 + 0.5, 0, z - 15 / 6)
			part.Transform:SetRotation(-95)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		...
		local part = SpawnPrefab("swinging_light_pendant_cherries")
		if part ~= nil then
			part.Transform:SetPosition(x - 1, 0, z - 15 / 6)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		if part ~= nil then
			part.Transform:SetPosition(x - 4, 0, z + 4.7)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end

		local part = SpawnPrefab("deco_produce_stone_cornerbeam")
		if part ~= nil then
		...
		local part = SpawnPrefab("deco_produce_menu_side")
		if part ~= nil then
			part.Transform:SetPosition(x, 0, z - 15 / 2)
		end

		local part = SpawnPrefab("deco_produce_menu")
		if part ~= nil then
			part.Transform:SetPosition(x - 10 / 2, 0, z - 15 / 6)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		if part ~= nil then
			part.Transform:SetPosition(x + 10 / 6, 0, z + 15 / 2)
		...
		if part ~= nil then
			part.Transform:SetPosition(x - 2.5, 0, z - 4.9)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x - 2.5, 0, z - 2.7)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x - 2.8, 0, z - 0.5)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x - 0.3, 0, z + 2.2)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x - 0.3, 0, z + 4.4)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1, 0, z - 5.1)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1, 0, z - 2.7)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1, 0, z - 0.5)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 2.7, 0, z + 2.2)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 2.7, 0, z + 4.4)
			part.startAnim = "idle_ice_box"
			part.AnimState:PlayAnimation("idle_ice_box")
			part.shoptype = "pig_shop_produce"
			if part.components.health ~= nil then
		...
		------------------------portoes trancados--------------------------------
		local part = SpawnPrefab("pig_shop_produce_floor")
		if part ~= nil then
		...
		inst:DoTaskInTime(0, function(inst)
			local portaentrada = SpawnPrefab("pig_shop_produce")
...
return Prefab("pig_shop_produce_entrance", entrance),
	Prefab("pig_shop_produce_door_saida", fnescada, assets),
	Prefab("pig_shop_produce_floor", SpawnPiso1, assets),
	Prefab("wallinteriorproduce", wall_common, assets)
