local assets =
{
	Asset("ANIM", "anim/tree_forest_build.zip"),
...
{
	normal = {
		file = "tree_forest_build",
		prefab_name = "tree_forest",
		normal_loot = { "log", "log", "tree_forestseed" },
		short_loot = { "log" },
		tall_loot = { "log", "log", "log", "tree_forestseed", "tree_forestseed" },
...
return tree("tree_forest", "normal", 0),
	tree("tree_forest_normal", "normal", 2),
	tree("tree_forest_tall", "normal", 3),
	tree("tree_forest_short", "normal", 1),
	tree("tree_forest_burnt", "normal", 0, "burnt"),
	tree("tree_forest_stump", "normal", 0, "stump")
