...
--	ShakeAllCameras(CAMERASHAKE.FULL, .35, .02, 1.25, inst, 40)	
    ...
    local isfriend = (target:HasTag("player")) or target:HasTag("companion") or target:HasTag("boatsw") or target:HasTag("ventania") or target:HasTag("lobster") or target:HasTag("ondamedia") or target:HasTag("FX")
