...
local function placeAlign(inst)
	...
	if true then
		if TheInput:IsKeyDown(TUNING.tro_pairedkey[TA_CONFIG.PERSONAL.build_rotation_key][2]) then
			rug_rotation = rug_rotation + 1
		elseif TheInput:IsKeyDown(TUNING.tro_pairedkey[TA_CONFIG.PERSONAL.build_rotation_key][1]) then
			rug_rotation = rug_rotation - 0.25
		end

		inst.Transform:SetRotation(rug_rotation)
	end
end
...
return Prefab("marsh/objects/rug_round", round, assets, prefabs),
	...
	MakePlacer("rug_round_placer", "rugs", "rugs", "rug_round", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_square_placer", "rugs", "rugs", "rug_square", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_oval_placer", "rugs", "rugs", "rug_oval", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_rectangle_placer", "rugs", "rugs", "rug_rectangle", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_leather_placer", "rugs", "rugs", "rug_leather", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_fur_placer", "rugs", "rugs", "rug_fur", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_circle_placer", "rugs", "rugs", "half_circle", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_hedgehog_placer", "rugs", "rugs", "rug_hedgehog", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_porcupuss_placer", "rugs", "rugs", "rug_porcupuss", nil, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_hoofprint_placer", "rugs", "rugs", "rug_hoofprints", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_octagon_placer", "rugs", "rugs", "rug_octagon", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_swirl_placer", "rugs", "rugs", "rug_swirl", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_catcoon_placer", "rugs", "rugs", "rug_catcoon", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_rubbermat_placer", "rugs", "rugs", "rug_rubbermat", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_web_placer", "rugs", "rugs", "rug_web", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_metal_placer", "rugs", "rugs", "rug_metal", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_wormhole_placer", "rugs", "rugs", "rug_wormhole", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_braid_placer", "rugs", "rugs", "rug_braid", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_beard_placer", "rugs", "rugs", "rug_beard", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_nailbed_placer", "rugs", "rugs", "rug_nailbed", nil, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_crime_placer", "rugs", "rugs", "rug_crime", true, nil, nil, 1, nil, nil, placefn),
	MakePlacer("rug_tiles_placer", "rugs", "rugs", "rug_tiles", true, nil, nil, 1, nil, nil, placefn)
