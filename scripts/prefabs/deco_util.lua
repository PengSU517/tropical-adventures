        ...
        if light then
            if followlight then
                ...
                inst:DoTaskInTime(0, function()
                    ...
                    -- local ent = FindEntity(inst, 20, nil, { "pisohousehamlet" })
                    -- local _x, _y, _z = ent.Transform:GetWorldPosition()
...
return
    ...
    Prefab("deco_wallpaper_rip2",
        decofn("interior_wall_decals", "wall_decals", "2", { decal = true, tags = { "NOBLOCK" } }), assets, prefabs),
    Prefab("deco_wallpaper_rip_side1",
        decofn("interior_wall_decals", "wall_decals", "10", { decal = true, tags = { "NOBLOCK" } }), assets, prefabs),
    Prefab("deco_wallpaper_rip_side2",
        decofn("interior_wall_decals", "wall_decals", "11", { decal = true, tags = { "NOBLOCK" }, background = 3 }),
        assets, prefabs),
    Prefab("deco_wallpaper_rip_side3", decofn("interior_wall_decals", "wall_decals", "8", { tags = { "NOBLOCK" } }),
        assets, prefabs),
    ...
    Prefab("deco_wood_beam",
        decofn("interior_wall_decals", "wall_decals", "3", {
            decal = true,
            tags = { "NOBLOCK", "cornerpost" },
            onbuilt = true
        }), assets, prefabs),
    Prefab("deco_round_beam",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "pillar_round_front",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_round_cornerbeam",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "pillar_round_corner",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),

    -- hat store
    Prefab("deco_millinery_beam",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "pillar_front",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_millinery_beam2",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "pillar_boxes_front",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_millinery_beam3",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "pillar_quilted_front",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_millinery_cornerbeam",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "pillar_corner",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_millinery_cornerbeam2",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "pillar_boxes_corner",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_millinery_cornerbeam3",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "pillar_quilted_corner",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("sewingmachine",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "sewingmachine",
            { decal = true, tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("worktable",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "worktable",
            { decal = true, tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("picture_1",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "picture1_sidewall", { decal = true }), assets,
        prefabs),
    Prefab("picture_2",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "picture2_sidewall", { decal = true }), assets,
        prefabs),
    Prefab("hat_lamp_side",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "sconce_sidewall", { decal = true }), assets,
        prefabs),
    Prefab("hat_lamp_front",
        decofn("interior_wall_decals_millinery", "wall_decals_millinery", "sconce_backwall", { decal = true }), assets,
        prefabs),
    Prefab("hatbox1", decofn("interior_wall_decals_millinery", "wall_decals_millinery", "hatbox1", { decal = true }),
        assets, prefabs),
    Prefab("hatbox2", decofn("interior_wall_decals_millinery", "wall_decals_millinery", "hatbox2", { decal = true }),
        assets, prefabs),

    -- weapon store
    Prefab("shield_axes", decofn("interior_wall_decals_weapons", "wall_decals_weapons", "shield_axes", { decal = true }),
        assets, prefabs),
    Prefab("shield_spears",
        decofn("interior_wall_decals_weapons", "wall_decals_weapons", "shield_spears", { decal = true }),
        assets, prefabs),
    Prefab("spears_sidewall",
        decofn("interior_wall_decals_weapons", "wall_decals_weapons", "spears_sidewall", { decal = true }), assets,
        prefabs),
    Prefab("shield_sidewall",
        decofn("interior_wall_decals_weapons", "wall_decals_weapons", "shield_sidewall", { decal = true }), assets,
        prefabs),
    Prefab("deco_weapon_beam1",
        decofn("interior_wall_decals_weapons", "wall_decals_weapons", "pillar_front",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_weapon_beam2",
        decofn("interior_wall_decals_weapons", "wall_decals_weapons", "pillar_corner",
            { decal = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("wall_light1", decofn("interior_wall_decals", "wall_decals", "6", { decal = true, light = true }), assets,
        prefabs),
    Prefab("wall_deco_truss1", decofn("interior_wall_decals", "wall_decals", "5", { scale = { x = 1.12, y = 1, z = 1 } }),
        assets, prefabs),
    Prefab("light_dust_fx", decofn("light_dust_fx", "light_dust_fx", "idle", { loopanim = true, tags = { "NOBLOCK" } }),
        assets, prefabs),

    -- hoofspa
    Prefab("deco_marble_beam",
        decofn("interior_wall_decals_hoofspa", "wall_decals_hoofspa", "pillar",
            {
                decal = true,
                loopanim = true,
    ...
    Prefab("deco_marble_cornerbeam",
        decofn("interior_wall_decals_hoofspa", "wall_decals_hoofspa", "pillar_corner",
            {
                decal = true,
                loopanim = true,
                light = DecoCreator:GetLights().SMALL,
    ...
    Prefab("deco_valence",
        decofn("interior_wall_decals_hoofspa", "wall_decals_hoofspa", "vallance_1pc", { decal = true, background = 3 }),
        assets, prefabs),
    Prefab("wall_mirror",
        decofn("interior_wall_mirror", "wall_mirror", "idle", { background = 3, followlight = true, mirror = true }),
        assets, prefabs),
    Prefab("deco_chaise",
        decofn("interior_floor_decor", "interior_floor_decor", "chaise",
            { physics = "sofa_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("wall_light_hoofspa",
        decofn("interior_wall_decals_hoofspa", "wall_decals_hoofspa", "sconce_sidewall",
            { light = DecoCreator:GetLights().SMALL }), assets, prefabs),
    Prefab("wall_light_hoofspa",
        decofn("interior_wall_decals_hoofspa", "wall_decals_hoofspa", "sconce_backwall",
            { light = DecoCreator:GetLights().SMALL }), assets, prefabs),
    ...
    Prefab("deco_ruins_wallcrumble_1",
        ...
        prefabs),
    Prefab("deco_ruins_wallcrumble_side_1",
        decofn("interior_wall_decals_ruins", "interior_wall_decals_ruins", "1", { decal = true }), assets, prefabs),
    ...
    -- florist
    Prefab("deco_wallpaper_florist_rip1",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "hole_1", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_wallpaper_florist_rip2",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "hole_2", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_wallpaper_florist_rip3",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "hole_3", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_wallpaper_florist_rip4",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "hole_4", { decal = true, background = 1 }),
        assets, prefabs),
    Prefab("deco_wallpaper_florist_side_rip1",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "hole_5_sidewall", { decal = true }),
        assets, prefabs),
    Prefab("deco_wallpaper_florist_side_rip2",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "hole_6_sidewall", { decal = true }),
        assets, prefabs),
    Prefab("deco_deli_meatrack",
        decofn("ceiling_decor", "ceiling_decor", "meatrack_idle", { loopanim = true }), assets, prefabs),
    Prefab("deco_deli_basket",
        decofn("ceiling_decor", "ceiling_decor", "wire_basket_idle", { loopanim = true }), assets, prefabs),
    Prefab("deco_general_hangingscale",
        decofn("ceiling_decor", "ceiling_decor", "scale_idle", { loopanim = true }), assets, prefabs),
    Prefab("deco_general_hangingpans",
        decofn("ceiling_decor", "ceiling_decor", "pans_idle", { loopanim = true }), assets, prefabs),
    Prefab("deco_general_trough",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "tiered_trough", { decal = true }), assets,
        prefabs),

    --arcane
    Prefab("closed_chest", decofn("interior_wall_decals_arcane", "wall_decals_arcane", "chest_closed", { decal = true }),
        assets, prefabs),
    Prefab("open_chest", decofn("interior_wall_decals_arcane", "wall_decals_arcane", "chest_open", { decal = true }),
        assets, prefabs),
    Prefab("containers", decofn("interior_wall_decals_arcane", "wall_decals_arcane", "containers", { decal = true }),
        assets, prefabs),
    Prefab("deco_arcane_bookshelf",
        decofn("interior_wall_decals_arcane", "wall_decals_arcane", "bookcase_backwall", { decal = true }), assets,
        prefabs),
    Prefab("mirror_backwall",
        decofn("interior_wall_decals_arcane", "wall_decals_arcane", "mirror_backwall", { decal = true }), assets, prefabs),

    --deli
    Prefab("deco_deli_stove_metal_side",
        decofn("interior_wall_decals_deli", "wall_decals_deli", "stove_sidewall", { decal = true }), assets, prefabs),
    Prefab("deco_deli_wallpaper_rip_side1",
        decofn("interior_wall_decals_deli", "wall_decals_deli", "hole_5", { decal = true }), assets, prefabs),
    Prefab("deco_deli_wallpaper_rip_side2",
        decofn("interior_wall_decals_deli", "wall_decals_deli", "hole_6", { decal = true }), assets, prefabs),
    Prefab("deco_produce_menu_side",
        decofn("interior_wall_decals_deli", "wall_decals_deli", "menu_sidewall", { decal = true }), assets, prefabs),
    Prefab("deco_produce_menu",
        decofn("interior_wall_decals_deli", "wall_decals_deli", "menu_front", { decal = true }), assets, prefabs),
    Prefab("deco_produce_stone_cornerbeam",
        decofn("interior_wall_decals_deli", "wall_decals_deli", "pillar_sidewall",
            { decal = true, light = DecoCreator:GetLights().SMALL_YELLOW }), assets, prefabs), -- loopanim=true,

    -- city hall
    Prefab("deco_cityhall_picture1",
        decofn("interior_wall_decals_mayorsoffice", "wall_decals_mayorsoffice", "picture1_sidewall", { decal = true }),
        assets, prefabs),
    Prefab("deco_cityhall_picture2",
        decofn("interior_wall_decals_mayorsoffice", "wall_decals_mayorsoffice", "picture2_sidewall", { decal = true }),
        assets, prefabs),
    Prefab("deco_cityhall_bookshelf",
        decofn("interior_wall_decals_mayorsoffice", "wall_decals_mayorsoffice", "bookcase_backwall", { decal = true }),
        assets, prefabs),
    Prefab("deco_cityhall_pillar",
        decofn("interior_wall_decals_mayorsoffice", "wall_decals_mayorsoffice", "pillar_round_corner",
            { decal = true, loopanim = true, light = DecoCreator:GetLights().SMALL }), assets, prefabs),
    Prefab("deco_cityhall_cornerbeam",
        decofn("interior_wall_decals_mayorsoffice", "wall_decals_mayorsoffice", "pillar_flag_corner",
            { decal = true, tags = { "cornerpost" } }), assets, prefabs), -- , background=3
    Prefab("window_mayorsoffice",
        decofn("window_mayorsoffice", "window_mayorsoffice", "day_loop",
            { loopanim = true, decal = true, background = 3, curtains = true }), assets, prefabs),
    Prefab("deco_cityhall_desk",
        decofn("interior_wall_decals_mayorsoffice", "wall_decals_mayorsoffice", "desk",
            { light = DecoCreator:GetLights().MED, physics = "desk_physics" }), assets, prefabs),
    -- palace
    Prefab("deco_palace_beam_room_tall",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "pillar_tall", {
            decal = false,
            physics = "post_physics"
        }), assets, prefabs),
    Prefab("deco_palace_beam_room_tall_lights",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "pillar_tall_lights",
            { decal = false, physics = "post_physics", light = DecoCreator:GetLights().SMALL }), assets, prefabs),
    Prefab("deco_palace_beam_room_tall_corner",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "pillar_tall_corner",
            { decal = false, physics = "post_physics" }), assets, prefabs),
    Prefab("deco_palace_beam_room_tall_corner_front",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "pillar_tall_front",
            { decal = false, physics = "post_physics" }), assets, prefabs),
    Prefab("window_palace",
        decofn("window_palace", "window_palace", "day_loop", {
            loopanim = true,
            decal = false,
            background = 3,
            curtains = true
        }), assets, prefabs),
    Prefab("window_palace_stainglass",
        decofn("window_palace_stainglass", "window_palace_stainglass", "day_loop",
            { loopanim = true, decal = false, background = 3, curtains = true }), assets, prefabs),
    Prefab("deco_palace_banner_big_front",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "banner_lg_front", { decal = false }), assets,
        prefabs),
    Prefab("deco_palace_banner_big_sidewall",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "banner_lg_sidewall", { decal = false }), assets,
        prefabs),
    Prefab("deco_palace_banner_small_front",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "banner_sml_front", { decal = false }), assets,
        prefabs),
    Prefab("deco_palace_banner_small_sidewall",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "banner_sml_sidewall", { decal = false }), assets,
        prefabs),
    Prefab("deco_palace_throne",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "throne",
            { decal = false, physics = "chair_physics" }),
        assets, prefabs),
    Prefab("deco_palace_beam_room_short_corner_lights",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "pillar_lights_corner",
            { decal = false, physics = "post_physics", light = DecoCreator:GetLights().SMALL }), assets, prefabs),
    Prefab("deco_palace_beam_room_short_corner_front_lights",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "pillar_lights_front",
            { decal = false, physics = "post_physics", light = DecoCreator:GetLights().SMALL }), assets, prefabs),
    Prefab("deco_palace_beam_room_short",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "pillar", { decal = false, physics = "post_physics" }),
        assets, prefabs),
    Prefab("deco_displaycase",
        decofn("interior_wall_decals_antiquities", "wall_decals_antiquities", "displayshelf_corner",
            { decal = false, physics = "post_physics" }), assets, prefabs),
    Prefab("deco_palace_plant",
        decofn("interior_wall_decals_palace", "wall_decals_palace", "plant", { decal = false }), assets, prefabs),


    --------------------------deco bank
    Prefab("deco_bank_clock1_side",
        decofn("interior_decor", "interior_decor", "clock1_sidewall", { decal = true }), assets, prefabs),
    Prefab("deco_bank_clock2_side",
        decofn("interior_decor", "interior_decor", "clock2_sidewall", { decal = true }), assets, prefabs),
    Prefab("deco_bank_clock3_side",
        decofn("interior_decor", "interior_decor", "clock3_sidewall", { decal = true }), assets, prefabs),
    Prefab("deco_bank_marble_beam",
        decofn("interior_pillar", "interior_pillar", "pillar_bank_front",
            {
                decal = true,
                loopanim = true,
                light = DecoCreator:GetLights().SMALL,
    ...
    Prefab("deco_bank_marble_cornerbeam",
        decofn("interior_pillar", "interior_pillar", "pillar_bank_corner",
            {
                decal = true,
                loopanim = true,
                light = DecoCreator:GetLights().SMALL,
    ...
    Prefab("deco_bank_vault",
        decofn("interior_unique", "interior_unique", "vault", { decal = true }), assets, prefabs),
    ---------deco_wall_ornament
    -- Prefab("deco_wallornament_photo",
    --     decofn("interior_wallornament", "interior_wallornament", "photo",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_fulllength_mirror",
    --     decofn("interior_wallornament", "interior_wallornament", "fulllength_mirror",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_embroidery_hoop",
    --     decofn("interior_wallornament", "interior_wallornament", "embroidery_hoop",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_mosaic",
    --     decofn("interior_wallornament", "interior_wallornament", "mosaic",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_wreath",
    --     decofn("interior_wallornament", "interior_wallornament", "wreath",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_axe",
    --     decofn("interior_wallornament", "interior_wallornament", "axe", {
    --         decal = true,
    --         tags = { "wallsection" },
    --         onbuilt = true
    --     }), assets, prefabs),
    -- Prefab("deco_wallornament_hunt",
    --     decofn("interior_wallornament", "interior_wallornament", "hunt", {
    --         decal = true,
    --         tags = { "wallsection" },
    --         onbuilt = true
    --     }), assets, prefabs),
    -- Prefab("deco_wallornament_periodic_table",
    --     decofn("interior_wallornament", "interior_wallornament", "periodic_table",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_gears_art",
    --     decofn("interior_wallornament", "interior_wallornament", "gears_art",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_cape",
    --     decofn("interior_wallornament", "interior_wallornament", "cape", {
    --         decal = true,
    --         tags = { "wallsection" },
    --         onbuilt = true
    --     }), assets, prefabs),
    -- Prefab("deco_wallornament_no_smoking",
    --     decofn("interior_wallornament", "interior_wallornament", "no_smoking",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    -- Prefab("deco_wallornament_black_cat",
    --     decofn("interior_wallornament", "interior_wallornament", "black_cat",
    --         { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),

    ----------------------deco_table--------------
    Prefab("deco_table_crate",
        decofn("interior_table", "interior_table", "table_crate",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_table_raw",
        decofn("interior_table", "interior_table", "table_raw",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_table_diy",
        decofn("interior_table", "interior_table", "table_diy",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_table_round",
        decofn("interior_table", "interior_table", "table_round",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_table_banker",
        decofn("interior_table", "interior_table", "table_banker",
            { physics = "sofa_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_table_chess",
        decofn("interior_table", "interior_table", "table_chess",
            { physics = "sofa_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
