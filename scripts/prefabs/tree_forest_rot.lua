...
local prefabs =
{
	"tree_forest_rot_seed",
}

local builds =
{
	normal = {
		file = "tree_forest_rot_build",
		prefab_name = "tree_forest_rot",
		normal_loot = { "log", "log", "tree_forest_rot_seed" },
		short_loot = { "log" },
		tall_loot = { "log", "log", "log", "tree_forest_rot_seed", "tree_forest_rot_seed" },
...
local function SetNormal(inst)
	...
	inst.components.lootdropper:SetLoot({ "log", "log", "tree_forest_rot_seed" })
...
local function SetTall(inst)
	...
	-- inst:AddTag("shelter")
	inst.components.lootdropper:SetLoot({ "log", "log", "log", "tree_forest_rot_seed", "tree_forest_rot_seed" })
...
local function makefn(build, stage, data)
	local function fn(Sim)
		...
		minimap:SetIcon("tree_forest_rot.tex")
		...
		inst.build = build
		anim:SetBuild("tree_forest_rot_build")
...
return tree("tree_forest_rot", "normal", 0),
	tree("tree_forest_rot_normal", "normal", 2),
	tree("tree_forest_rot_tall", "normal", 3),
	tree("tree_forest_rot_short", "normal", 1),
	tree("tree_forest_rot_burnt", "normal", 0, "burnt"),
	tree("tree_forest_rot_stump", "normal", 0, "stump")
