...
local function onhit(inst, worker)
    if not inst:HasTag("burnt") then
        ...
        inst.AnimState:PlayAnimation("hit_beaver1")
        inst.AnimState:PushAnimation("idle_beaver1")
    end
end
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("wildbeaver_house.tex")

    inst.AnimState:SetBank("merm_sw_house")
    inst.AnimState:SetBuild("wildbea_house")
    inst.AnimState:PlayAnimation("idle_beaver1")
...
local function fn1()
    ...
    inst.MiniMapEntity:SetIcon("pigiglu.tex")
...
local function fn2()
    ...
    inst.MiniMapEntity:SetIcon("pig_shop_spears.tex")

    inst.AnimState:SetBank("merm_sw_house")
    inst.AnimState:SetBuild("wildbea_house")
    inst.AnimState:PlayAnimation("idle_hunt1")
    inst.Transform:SetScale(0.8, 0.8, 0.8)
