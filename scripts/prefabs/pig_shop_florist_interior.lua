...
local function entrance()
	...
	if inst.entrada == nil then
		...
		inst.exit = SpawnPrefab("pig_shop_florist_door_saida")
		...
		----------------parede do fundo---------------------------------------------
		local part = SpawnPrefab("wallinteriorflorist")
		if part ~= nil then
		...
		------------------------portoes trancados--------------------------------
		local part = SpawnPrefab("pig_shop_florist_floor")
		if part ~= nil then
...
local function wall_common(build)
	...
	inst.AnimState:PlayAnimation("shop_wall_sunflower", true)
...
return Prefab("pig_shop_florist_entrance", entrance),
	Prefab("pig_shop_florist_door_saida", fnescada, assets),
	Prefab("pig_shop_florist_floor", SpawnPiso1, assets),
	Prefab("wallinteriorflorist", wall_common, assets)
