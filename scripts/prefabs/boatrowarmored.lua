...
local function onhammered(inst)
	...
	SpawnPrefab("boards").Transform:SetPosition(inst.Transform:GetWorldPosition())
	SpawnPrefab("boards").Transform:SetPosition(inst.Transform:GetWorldPosition())
	SpawnPrefab("rope").Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function equipaItem(inst, data)
	...
	if luzslot and luzslot:HasTag("boatlight") then luzslot.navio = inst end
...
local function fn()
	...
	minimap:SetIcon("armouredboat.tex")
	...
	inst.replica.container:WidgetSetup("armouredboat")
	--------------------------------------------------------------------------
...
return Prefab("armouredboat", fn, assets)
