...
local function entrance()
	...
	if inst.entrada == nil then
		...
		if part ~= nil then
			...
			part.shoptype = "pig_shop_antiquities"
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1.7, 0, z + (15 / 2) - 2.5)
			part.startAnim = "idle_barrel_dome"
			part.AnimState:PlayAnimation("idle_barrel_dome")
			part.shoptype = "pig_shop_antiquities"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 2.9, 0, z + 3)
			part.startAnim = "idle_barrel_dome"
			part.AnimState:PlayAnimation("idle_barrel_dome")
			part.shoptype = "pig_shop_antiquities"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1.9, 0, z - (15 / 2) + 2.5)
			part.startAnim = "idle_barrel_dome"
			part.AnimState:PlayAnimation("idle_barrel_dome")
			part.shoptype = "pig_shop_antiquities"
			if part.components.health ~= nil then
		...
		inst:DoTaskInTime(1, function(inst)
			local portaentrada = SpawnPrefab("pig_shop_antiquities")
