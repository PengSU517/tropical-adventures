...
local function entrance()
	...
	if inst.entrada == nil then
		...
		inst.exit = SpawnPrefab("hatshop_door_saida")
		...
		----------------parede do fundo---------------------------------------------
		local part = SpawnPrefab("wallinteriorhatshop")
		if part ~= nil then
		...
		---------------------------------itens de dentro----------------------------
		local part = SpawnPrefab("shelves_floating")
		if part ~= nil then
		...
		local part = SpawnPrefab("pigman_hatmaker_shopkeep")
		if part ~= nil then
			part.Transform:SetPosition(x - 3.5, 0, z + 5)
		...
		local part = SpawnPrefab("shelves_pipe")
		if part ~= nil then
			part.Transform:SetPosition(x - 4.5, 0, z - 3.5)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		if part ~= nil then
			part.Transform:SetPosition(x, 0, z + 0)
		...
		local part = SpawnPrefab("hat_lamp_side")
		if part ~= nil then
		...
		local part = SpawnPrefab("sewingmachine")
		if part ~= nil then
		...
		local part = SpawnPrefab("hatbox1")
		if part ~= nil then
			part.Transform:SetPosition(x - 2, 0, z + 6.5)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		local part = SpawnPrefab("hatbox1")
		if part ~= nil then
			part.Transform:SetPosition(x + 4, 0, z - 6.5)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end

		local part = SpawnPrefab("hatbox2")
		if part ~= nil then
			part.Transform:SetPosition(x + 4.5, 0, z - 5.75)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end

		local part = SpawnPrefab("deco_millinery_cornerbeam2")
		if part ~= nil then
		...
		local part = SpawnPrefab("deco_millinery_beam3")
		if part ~= nil then
		...
		local part = SpawnPrefab("deco_millinery_beam2")
		if part ~= nil then
			part.Transform:SetPosition(x + 4.7, 0, z + 15 / 2)
			part.Transform:SetRotation(180)
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("deco_millinery_cornerbeam3")
		if part ~= nil then
			part.Transform:SetPosition(x - 5, 0, z + 15 / 2)
			part.Transform:SetRotation(180)
			if part.components.health ~= nil then
		...
		if part ~= nil then
			part.Transform:SetPosition(x - 3, 0, z + 15 / 6)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		if part ~= nil then
			part.Transform:SetPosition(x - 15 / 2, 0, z - 5)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		local part = SpawnPrefab("picture_1")
		if part ~= nil then
			part.Transform:SetPosition(x - 2.5, 0, z + 15 / 2)
			part.Transform:SetRotation(180)
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		...
		local part = SpawnPrefab("picture_2")
		if part ~= nil then
			part.Transform:SetPosition(x + 2.5, 0, z + 15 / 2)
			part.Transform:SetRotation(180)
			if part.components.health ~= nil then
		...
		if part ~= nil then
			part.Transform:SetPosition(x - 1, 0, z - 3.5)
			part.startAnim = "idle_hatbox2"
			part.AnimState:PlayAnimation("idle_hatbox2")
			part.shoptype = "pig_shop_hatshop"
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		end
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x - 1, 0, z - 1)
			part.startAnim = "idle_hatbox4"
			part.AnimState:PlayAnimation("idle_hatbox4")
			part.shoptype = "pig_shop_hatshop"
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x - 1, 0, z + 1.5)
			part.startAnim = "idle_hatbox2"
			part.AnimState:PlayAnimation("idle_hatbox2")
			part.shoptype = "pig_shop_hatshop"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1.5, 0, z - 4.5)
			part.startAnim = "idle_hatbox3"
			part.AnimState:PlayAnimation("idle_hatbox3")
			part.shoptype = "pig_shop_hatshop"
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		...
		if part ~= nil then
			...
			part.startAnim = "idle_hatbox1"
			part.AnimState:PlayAnimation("idle_hatbox1")
			part.shoptype = "pig_shop_hatshop"
			if part.components.health ~= nil then
				part.components.health:SetPercent(1)
			end
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1.5, 0, z + 0.5)
			part.startAnim = "idle_hatbox1"
			part.AnimState:PlayAnimation("idle_hatbox1")
			part.shoptype = "pig_shop_hatshop"
			if part.components.health ~= nil then
		...
		local part = SpawnPrefab("shop_buyer")
		if part ~= nil then
			part.Transform:SetPosition(x + 1.5, 0, z + 3)
			part.startAnim = "idle_hatbox3"
			part.AnimState:PlayAnimation("idle_hatbox3")
			part.shoptype = "pig_shop_hatshop"
			if part.components.health ~= nil then
		...
		------------------------portoes trancados--------------------------------
		local part = SpawnPrefab("pig_shop_hatshop_floor")
		if part ~= nil then
		...
		inst:DoTaskInTime(0, function(inst)
			local portaentrada = SpawnPrefab("pig_shop_hatshop")
...
local function SpawnPiso1(inst)
	...
	inst.AnimState:PlayAnimation("shop_floor_checkered")
...
local function wall_common(build)
	...
	inst.AnimState:PlayAnimation("shop_wall_floraltrim2", true)
...
return Prefab("hatshop_entrance", entrance),
	Prefab("hatshop_door_saida", fnescada, assets),
	Prefab("pig_shop_hatshop_floor", SpawnPiso1, assets),
	Prefab("wallinteriorhatshop", wall_common, assets)
