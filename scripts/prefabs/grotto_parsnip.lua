...
local function fn3()
	...
	minimap:SetIcon("grotto_parsnip_giant.tex")
	...
	inst.components.lootdropper:SetLoot({ "grotto_parsnip", "grotto_parsnip", "grotto_parsnip", "grotto_parsnip_eaten",
		"grotto_parsnip_eaten", "mosquito", "mosquito", "jellybug" })
