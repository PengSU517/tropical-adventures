...
local function onhammered(inst)
	...
	SpawnPrefab("bamboo").Transform:SetPosition(inst.Transform:GetWorldPosition())
	SpawnPrefab("bamboo").Transform:SetPosition(inst.Transform:GetWorldPosition())
...
return Prefab("raft_old", fn, assets),
	MakePlacer("raft_placer", "raft", "raft_build", "run_loop")
