...
local function OnAttacked(inst, data)
	...
	inst.components.combat:ShareTarget(data.attacker, shareRange,
		function(dude) return dude:HasTag("mosquito") and not dude.components.health:IsDead() end, MAX_TARGET_SHARES)
end
