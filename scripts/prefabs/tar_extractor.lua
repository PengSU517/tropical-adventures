...
local function spawnTarProp(inst)
	...
	local offset = 1.3
	local variation = 0.2
	tar.Transform:SetPosition(pt.x + (right.x * offset) + (math.random() * variation), 0,
		pt.z + (right.z * offset) + (math.random() * variation))
...
return Prefab("tar_extractor", fn, assets, prefabs),
	MakePlacer("tar_extractor_placer", "tar_extractor", "tar_extractor", "idle", nil, nil, nil, nil, nil, nil, nil, nil,
		nil, placeTestFn)
