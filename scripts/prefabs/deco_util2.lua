...
return
-------------------deco_plantholder------
    Prefab("deco_plantholder_basic",
        decofn("interior_plant", "interior_plant", "plant_basic", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_wip",
        decofn("interior_plant", "interior_plant", "plant_wip", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_fancy",
        decofn("interior_plant", "interior_plant", "plant_fancy", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_bonsai",
        decofn("interior_plant", "interior_plant", "plant_bonsai", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_dishgarden",
        decofn("interior_plant", "interior_plant", "plant_dishgarden", { tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_plantholder_philodendron",
        decofn("interior_plant", "interior_plant", "plant_philodendron", { tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_plantholder_orchid",
        decofn("interior_plant", "interior_plant", "plant_orchid", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_draceana",
        decofn("interior_plant", "interior_plant", "plant_draceana", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_xerographica",
        decofn("interior_plant", "interior_plant", "plant_xerographica", { tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_plantholder_birdcage",
        decofn("interior_plant", "interior_plant", "plant_birdcage", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_palm",
        decofn("interior_plant", "interior_plant", "plant_palm", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_zz",
        decofn("interior_plant", "interior_plant", "plant_zz", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_fernstand",
        decofn("interior_plant", "interior_plant", "plant_fernstand", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_fern",
        decofn("interior_plant", "interior_plant", "plant_fern", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_terrarium",
        decofn("interior_plant", "interior_plant", "plant_terrarium", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_plantpet",
        decofn("interior_plant", "interior_plant", "plant_plantpet", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_traps",
        decofn("interior_plant", "interior_plant", "plant_traps", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_pitchers",
        decofn("interior_plant", "interior_plant", "plant_pitchers", { tags = { "furniture" }, onbuilt = true }), assets,
        prefabs),
    Prefab("deco_plantholder_marble",
        decofn("interior_floor_decor", "interior_floor_decor", "plant", { tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    ...
    --------------deco academy-------
    Prefab("deco_accademy_barrier",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "velvetrope_backwall",
            { physics = "sofa_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_accademy_barrier_vert",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "velvetrope_sidewall",
            { physics = "sofa_physics_vert", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_accademy_vause",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "sculpture_vase",
            { tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_accademy_graniteblock",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "stoneblock",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_accademy_potterywheel_urn",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "pottingwheel_urn",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_accademy_potterywheel",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "pottingwheel",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_accademy_anvil",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "anvil",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_accademy_table_books",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "table_books",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    ...
    Prefab("deco_accademy_pig_king_painting",
        decofn("interior_wall_decals_accademia", "wall_decals_accademia", "picture_backwall",
            { decal = true, tags = { "wallsection" }, onbuilt = true }), assets, prefabs),
    ------------deco_antiquities----------------
    Prefab("deco_antiquities_screamcatcher",
        decofn("ceiling_decor", "ceiling_decor", "scream_catcher_idle", { loopanim = true }), assets, prefabs),
    Prefab("deco_antiquities_windchime",
    ...
    Prefab("deco_antiquities_wallpaper_rip1",
        decofn("interior_wall_decals_antiquities", "wall_decals_antiquities", "hole_1", { decal = true, background = 3 }),
        assets, prefabs),
    Prefab("deco_antiquities_wallpaper_rip2",
        decofn("interior_wall_decals_antiquities", "wall_decals_antiquities", "hole_2", { decal = true, background = 3 }),
        assets, prefabs),
    Prefab("deco_antiquities_wallpaper_rip3",
        decofn("interior_wall_decals_antiquities", "wall_decals_antiquities", "hole_3", { decal = true, background = 3 }),
        assets, prefabs),
    Prefab("deco_antiquities_walllight",
        decofn("interior_wall_decals_antiquities", "wall_decals_antiquities", "sconce_sidewall1",
            { decal = true, light = DecoCreator:GetLights().SMALL, tags = { "NOBLOCK" } }), assets, prefabs),


    -------------------deco_chair-----------------------
    Prefab("deco_chair_classic",
        decofn("interior_chair", "interior_chair", "chair_classic",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_corner",
        decofn("interior_chair", "interior_chair", "chair_corner",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_bench",
        decofn("interior_chair", "interior_chair", "chair_bench",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_horned",
        decofn("interior_chair", "interior_chair", "chair_horned",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_footrest",
        decofn("interior_chair", "interior_chair", "chair_footrest",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_lounge",
        decofn("interior_chair", "interior_chair", "chair_lounge",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_massager",
        decofn("interior_chair", "interior_chair", "chair_massager",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_stuffed",
        decofn("interior_chair", "interior_chair", "chair_stuffed",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_rocking",
        decofn("interior_chair", "interior_chair", "chair_rocking",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    Prefab("deco_chair_ottoman",
        decofn("interior_chair", "interior_chair", "chair_ottoman",
            { physics = "chair_physics", tags = { "furniture" }, decal = true, onbuilt = true }), assets, prefabs),
    ...
    Prefab("deco_florist_hangingplant1", decofn("ceiling_decor", "ceiling_decor", "plant1_idle", { loopanim = true }),
        assets, prefabs),
    Prefab("deco_florist_hangingplant2", decofn("ceiling_decor", "ceiling_decor", "plant2_idle", { loopanim = true }),
        assets, prefabs),
    Prefab("deco_florist_plantholder",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "plantstand"), assets, prefabs),
    Prefab("deco_florist_latice_front",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "lattice_front"), assets, prefabs),
    Prefab("deco_florist_latice_side",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "lattice_sidewall", { decal = true }),
        assets, prefabs),
    Prefab("deco_florist_pillar_front",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "pillar_front", { decal = true }), assets,
        prefabs),
    Prefab("deco_florist_pillar_side",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "pillar_sidewall", { decal = true }),
        assets, prefabs),
    Prefab("deco_florist_picture",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "pictureframe_front",
            { decal = true, background = 2 }), assets, prefabs),
    Prefab("deco_florist_cagedplant",
        decofn("interior_wall_decals_florist", "interior_wall_decals_florist", "cageplant_front",
            { decal = true, background = 2 }), assets, prefabs),

    -- Tinker
    Prefab("deco_tinker_beam",
        decofn("interior_pillar", "interior_pillar", "basic_front",
            { decal = true, loopanim = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_tinker_cornerbeam",
        decofn("interior_pillar", "interior_pillar", "basic_corner",
            { decal = true, loopanim = true, tags = { "NOBLOCK", "cornerpost" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_rollholder",
        decofn("interior_floor_decor", "interior_floor_decor", "rollholder",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_rollholder_front",
        decofn("interior_floor_decor", "interior_floor_decor", "rollholder_front",
            { physics = "sofa_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_filecabinet",
        decofn("interior_floor_decor", "interior_floor_decor", "filecabinet",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_rollchest",
        decofn("interior_floor_decor", "interior_floor_decor", "chest_open",
            { physics = "post_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),
    Prefab("deco_worktable",
        decofn("interior_floor_decor", "interior_floor_decor", "worktable",
            { physics = "sofa_physics", tags = { "furniture" }, onbuilt = true }), assets, prefabs),


    ------------deco_lamp
    Prefab("deco_lamp_fringe",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_fringe",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_stainglass",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_stainglass",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_downbridge",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_downbridge",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_2embroidered",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_2embroidered",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_ceramic",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_ceramic",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_glass",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_glass",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_2fringes",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_2fringes",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_candelabra",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_candelabra",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_elizabethan",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_elizabethan",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_gothic",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_gothic",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_orb",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_orb",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_bellshade",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_bellshade",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_crystals",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_crystals",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_upturn",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_upturn",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_2upturns",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_2upturns",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_spool",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_spool",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_edison",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_edison",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_adjustable",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_adjustable",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_rightangles",
        decofn("interior_floorlamp", "interior_floorlamp", "floorlamp_rightangles",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
    Prefab("deco_lamp_hoofspa",
        decofn("interior_floor_decor", "interior_floor_decor", "lamp",
            { physics = "post_physics", light = DecoCreator:GetLights().SMALL, tags = { "furniture" }, onbuilt = true }),
        assets, prefabs),
