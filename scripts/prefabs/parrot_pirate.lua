...
local assets =
{
    ...
    Asset("ANIM", "anim/parrot_pirate_build"),
}
...
local function makebird(name, soundname, loottable, psprefab, foodtype, scale)
    ...
    local function fn()
        ...
        inst.AnimState:SetBank("parrot_pirate_bird")
    ...
    return Prefab("parrot_pirate", fn, assets, prefabs)
end
...
return
    makebird(
        "parrot_pirate",
        "canary",
        { { "dubloon", 0.5 }, { "smallmeat", 0.5 }, { "dubloon", 0.1 } },
        "dubloon",
        1
    )
