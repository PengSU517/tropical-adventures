...
local function entrance()
	...
	if inst.entrada == nil then
		...
		inst.exit = SpawnPrefab("pig_shop_spears_door_saida")
		...
		----------------parede do fundo---------------------------------------------
		local part = SpawnPrefab("wallinteriorspears")
		if part ~= nil then
	...
	part.components.health:SetPercent(1)
		...
		------------------------portoes trancados--------------------------------
		local part = SpawnPrefab("pig_shop_spears_floor")
		if part ~= nil then
...
return Prefab("pig_shop_spears_entrance", entrance),
	Prefab("pig_shop_spears_door_saida", fnescada, assets),
	Prefab("pig_shop_spears_floor", SpawnPiso1, assets),
	Prefab("wallinteriorspears", wall_common, assets)
