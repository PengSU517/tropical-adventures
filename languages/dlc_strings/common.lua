...
STRINGS.UI =
{
    ...
    BUGREPORTSCREEN = {
        ...
        SUBMIT_TEXT =
        "This will record the performance of your game for %d seconds, and then upload a report and your savegame to Klei.\nThis will save your current game!\nContinue?",
        ...
        SUBMIT_DIALOG_BODY =
        "Submitting a bug report will upload your game information and saved worlds to Klei to help us analyze the issue.\n\nThis may take several minutes.",
        SUBMIT_TEXT_PLACEHOLDER =
        "Please enter a description of the bug you are experiencing and any details that you feel may aid us in fixing it.",
    ...
    EMAILSCREEN =
    {
        ...
        SIGNUPFAIL =
        "Looks like we had some trouble signing you up. Please try again later if you don't receive a confirmation email.",
        INVALIDEMAILTITLE = "Invalid Email",
        INVALIDEMAIL =
        "We aren't psychic! If you don't enter your email address, we won't be able to tell you about new stuff!",
        INVALIDDATETITLE = "Invalid Date",
        INVALIDDATE =
        "We need your birthdate or ratings people might get mad at us for emailing you content not appropriate for your age.",
        OK = "OK",
        SUBSCRIBE = "Subscribe",
        CANCEL = "Cancel",
    ...
    OPTIONS =
    {
        ...
        RESTART_DYNAMIC_LOADING_BODY =
        "For Dynamic Asset Loading changes to take effect, you will have to exit and restart the game.",
        OK = "Ok",
    ...
    SAVEINTEGRATION =
    {
        ...
        "This will revert both worlds to the state they were in before the merge. Any progress you made after the merge will be lost. \nDo you wish to continue?",
        CHOOSE_SLOT = "OVERWRITE SLOT",
        UNDERSTOOD = "I Understand",
        CANCEL = "Cancel",
        MERGE_TARGET = "Choose Merge",
        NO_EMPTY_SLOTS = "No empty slots available",
        NO_EMPTY_SLOTS_DESCRIPTION =
        "Restoring a saved game requires at least one free save slot. Delete an old game to continue.",
        EMPTY_SLOT = "Empty slot",

        SW_COMP = "Shipwrecked Compatibility",
        SW_COMP_DESCRIPTION =
        "Would you like to make this world compatible with Shipwrecked? This will add new mechanics to your world like wetness and overheating.\n\n Only Shipwrecked compatible mods will function in this save slot.",
        SW_COMP_ROG_DESCRIPTION =
        "Would you like to make this world compatible with Shipwrecked?\n\n Only Shipwrecked compatible mods will function in this save slot.",
        ...
        PORK_COMP_DESCRIPTION =
        "Would you like to make this world compatible with Hamlet? This will add new mechanics to your world like wetness and overheating.\n\n Only Hamlet compatible mods will function in this save slot.",
        PORK_COMP_ROG_DESCRIPTION =
        "Would you like to make this world compatible with Hamlet?\n\n Only Hamlet compatible mods will function in this save slot.",
        PORK_COMP_SW_DESCRIPTION =
        "Would you like to make this world compatible with Hamlet?\n\n Only Hamlet compatible mods will function in this save slot.",
    ...
    NEWGAMESCREEN =
    {
        ...
        ROG_WARNING_BODY =
        "Don't Starve: Reign of Giants is an expansion geared towards experienced Don't Starve players. You can disable the expansion when starting a new game.\n\nDo you want to continue with Reign of Giants enabled?",
        YES = "Yes",
        NO = "No",
    ...
    SLOTDETAILSSCREEN =
    {
        ...
        MODSDISABLEDWARNINGBODY_EXPLANATION =
        "Some mods used on this save are disabled. Loading with disabled mods could cause issues. Disabled mods:",
    ...
    STARTADVENTURE =
    {
        ...
        BODY_TEST =
        "If you die during adventure mode, you will return back to this portal where you may restart the adventure.\n\nYou're about to step into a long, arduous journey to find Maxwell. You will need to survive 5 worlds, each randomly generated to present a new challenge.",
        YES = "Let's Go!",
        NO = "Not Yet",
    },
    ...
    TELEPORTBODY_ADVENTURE =
    "This will REMOVE ALL YOUR ITEMS and destroy your current world. Only items placed in the machine will appear in the next world.",
