return {
	...
	DESCRIBE =
	{
		...
		DOGFISH_DEAD = "It has shed its earthly tether.",
		...
		MESSAGEBOTTLE_SW = "The last, desperate act of a doomed soul. In a bottle.",
		MESSAGEBOTTLEEMPTY_SW = "Empty. Like my soul.",
