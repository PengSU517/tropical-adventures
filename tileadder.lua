...
local newTilesProperties = {
    ...
    foundation = { specs = { name = "blocky" }, turf = { { "turf_foundation" } }, layer = 20, isfloor = true },
    ...
    marsh_sw = { specs = { name = "marsh_sw" }, turf = nil, layer = 25 },                     --frost lake	
    -- lilypond = { specs = { name = "lilypond" }, nil, layer = 10 },                      --frost lake			
}                                                                                             --Loading data from tiledescription.lua
