...
for _, v in pairs(LOCKS) do
	if v >= locks then locks = v + 1 end
end

local keys = 1
for _, v in pairs(KEYS) do
	if v >= keys then keys = v + 1 end
end
...
AddCustomizeGroup("WORLDGEN", "TROPICAL_EXPERIENCE", "Tropical Experience", yesno_descriptions, "images/inventoryimages/volcanoinventory.xml", 0)
...
GLOBAL.STRINGS.UI.CUSTOMIZATIONSCREEN.ITEM1 = "Item 1"
GLOBAL.STRINGS.UI.CUSTOMIZATIONSCREEN.ITEM2 = "Item 2"
GLOBAL.STRINGS.UI.CUSTOMIZATIONSCREEN.ITEM3 = "Item 3"
AddCustomizeItem("WORLDGEN","TROPICAL_EXPERIENCE", "item1", {

atlas = "images/inventoryimages/volcanoinventory.xml", 
value = 1, 
image = "mermhouse_tropical.png", 
options_remap = {img = "mermhouse_tropical.png", atlas = "images/inventoryimages/volcanoinventory.xml"},
desc = yesno_descriptions,
order = 1,
world={"forest"}
})

AddCustomizeItem("WORLDGEN","TROPICAL_EXPERIENCE", "item2", {

atlas = "images/inventoryimages/volcanoinventory.xml", 
value = 2, 
image = "palmleaf.tex", 
--options_remap = {img = "palmleaf.tex", atlas = "images/inventoryimages/volcanoinventory.xml"},
desc = yesno_descriptions,
order = 2,
world={"forest"}
})

AddCustomizeItem("WORLDGEN","TROPICAL_EXPERIENCE", "item3", {

atlas = "images/inventoryimages/volcanoinventory.xml", 
value = 2, 
image = "doydoy.tex", 
--options_remap = {img = "doydoy.tex", atlas = "images/inventoryimages/volcanoinventory.xml"},
desc = yesno_descriptions,
order = 3,
world={"forest"}
})
...
AddRoom("deeprainforest_flytrap_grove", {
					...
					contents =  {
									countstaticlayouts={
										["pig_ruins_head"]= math.max(0,2 - math.random(0,20)),
										["pig_ruins_artichoke"]= math.max(0,2 - math.random(0,20)),
										["nettlegrove"] = function() if math.random(1, 10) > 7 then return 1 end return 0 end,									
									},
...
AddTask("pantano", {
		...
		room_bg=GROUND.MARSH,GROUND.OCEAN_COASTAL_SHORE,
...
--        [salasjungle[math.random(1, 33)]] = 1,
    ...
    room_bg=GROUND.BEACH,
	background_room="MagmaGold", "MagmaHomeBoon",
	colour={1,.5,.5,.2},
	})
...
if GetModConfigData("Shipwrecked") == 20 then	
	...
	room_bg=GROUND.JUNGLE,
	background_room="MAINBeachSand", "MAINBeachUnkept",
	colour={1,.5,.5,.2},
	})
...
--        [salasjungle1[math.random(1, 33)]] = 1,
    ...
    room_bg=GROUND.BEACH,
	background_room="MAINMagmaGold", "MAINMagmaHomeBoon",
	colour={1,.5,.5,.2},
	})
...
AddRoom("MAINdeeprainforest_flytrap_grove", {
					...
					tags = {"ExitPiece","RoadPoison", "folha"},
					contents =  {
									countstaticlayouts={["nettlegrove"] = function() if math.random(1, 10) > 7 then return 1 end return 0 end},	
					                distributepercent =  0.25,
					                distributeprefabs=
					                {
										rainforesttree = 4,
...
AddRoom("strange_island_eldorado", {
					colour={r=.55,g=.75,b=.75,a=.50},
					value = GROUND.QUAGMIRE_PARKFIELD,
					tags = {"RoadPoison", "tropical", "StagehandGarden", "Terrarium_Spawner", "StatueHarp_HedgeSpawner", "CharlieStage_Spawner"},					
					contents =  {	
...
AddRoom("JungleClearing", {
					colour={r=.5,g=0.6,b=.080,a=.10},
					value = GROUND.JUNGLE,
					tags = {"RoadPoison","Chester_Eyebone", "tropical", "StagehandGarden", "Terrarium_Spawner", "StatueHarp_HedgeSpawner", "CharlieStage_Spawner"},
					contents =  {
...
AddTask("MKiller bees!", {
		...
		room_choices={
			--["Wormhole"] = 1,
			["Waspnests1"] = function() return math.random(SIZE_VARIATION) end, 
			["Forest"] = function() return math.random(SIZE_VARIATION) end, 
			["FlowerPatch"] = function() return math.random(SIZE_VARIATION) end, 
		},  
		room_bg=GROUND.GRASS,
...
AddTask("cherry_arquipelago", {
	...
	room_choices =
	{
		...
		["CherryBugs"] = GetCherryForestSize(-1, 1, 4),
		
		["CherryDeepForest"] = 1,
		["CherrySpawn"] = 1,
		["CherryTrees"] = GetCherryForestSize(-2, 0, 3),
		
		["CherryWeb"] = GetCherryForestSize(-2, 0, 1),
		
		--["BGGrass"] = GetCherryForestSize(-1, 0, 2),
	},
	...
	cove_room_chance = 1,
	cove_room_max_edges = 2,
	colour={r=.5,g=0.6,b=.080,a=.10},	colour={r = 1, g = 0.4, b = 0.4, a = 0.1},})
...
AddTask("cherry_grove", {
	...
	room_choices =
	{
		["CherryForestIsland"] = GetCherryForestSize(2, 1, 5),
		["CherryBugs"] = GetCherryForestSize(-2, 1, 3),
		
		["CherryDeepForest"] = 1,
		["CherrySpawn"] = 1,
		["CherryTrees"] = GetCherryForestSize(-2, 0, 2),
...
AddTask("cherry_island", {
	...
	room_choices =
	{
		["CherryForestIsland"] = GetCherryForestSize(2, 2, 6),
		["CherryBugs"] = GetCherryForestSize(-1, 1, 4),
		...
		["CherryWeb"] = GetCherryForestSize(-1, 0, 1),
		
		--["BGGrass"] = GetCherryForestSize(-2, 0, 2),
	},
	room_bg = WORLD_TILES.GRASS,
	background_room = "Empty_Cove",
...
AddTask("cherry_mainland", {
	...
	room_tags = {"cherryarea"},
	room_choices={ 
		["CherryForest"] = GetCherryForestSize(1, 2, 5),
		["CherryBugs"] = GetCherryForestSize(-1, 1, 3),
		
		["CherryDeepForest"] = 1,
		["CherrySpawn"] = 1,
		["CherryTrees"] = GetCherryForestSize(-2, 0, 2),
		
		["CherryVillage"] = GetCherryForestSize(-2, 0, 1),
	}, 
...
taskset.set_pieces["BathbombedHotspring"] = {count = 1, tasks={"MoonIsland_Baths"}}
taskset.set_pieces["MoonFissures"] = {count = 1, tasks={"MoonIsland_Fissures","MoonIsland_Mine","MoonIsland_Forest"}}
end


if GetModConfigData("togethercaves_shipwreckedworld") == 1 then
taskset.set_pieces["CaveEntrance"] = { count = 10, tasks=
{
"HomeIslandSmall",
"HomeIslandSmallBoon",
"HomeIslandMed",
...
if GetModConfigData("tropicalshards") ~= 0 then
taskset.set_pieces["sw_exit"] = { count = 1, tasks={ 
"HomeIslandSmall",
"HomeIslandSmallBoon",
"HomeIslandMed",
"HomeIslandLarge",
...
if GetModConfigData("hamletcaves_shipwreckedworld") == 1 then			
taskset.set_pieces["cave_entranceham1"] = { count = 1, tasks={
"HomeIslandSmall",
"HomeIslandSmallBoon",
"HomeIslandMed",
"HomeIslandLarge",
...
taskset.set_pieces["cave_entranceham2"] = { count = 1, tasks={
"HomeIslandSmall",
"HomeIslandSmallBoon",
"HomeIslandMed",
"HomeIslandLarge",
...
taskset.set_pieces["cave_entranceham3"] = { count = 1, tasks={
"HomeIslandSmall",
"HomeIslandSmallBoon",
"HomeIslandMed",
"HomeIslandLarge",
...
"CrashZone", 
	...
	taskset.ocean_prefill_setpieces["coralpool1"] = { count = 3*GetModConfigData("coralbiome")}
	taskset.ocean_prefill_setpieces["coralpool2"] = { count = 3*GetModConfigData("coralbiome")}
	taskset.ocean_prefill_setpieces["coralpool3"] = { count = 2*GetModConfigData("coralbiome")}
	taskset.ocean_prefill_setpieces["octopuskinghome"] = { count = GetModConfigData("octopusking")}	
	taskset.ocean_prefill_setpieces["mangrove1"] = { count = 2*GetModConfigData("mangrove")}
	taskset.ocean_prefill_setpieces["mangrove2"] = { count = GetModConfigData("mangrove")}	
	taskset.ocean_prefill_setpieces["wreck"] = { count = GetModConfigData("shipgraveyard")}	
	taskset.ocean_prefill_setpieces["wreck2"] = { count = GetModConfigData("shipgraveyard")}	
	taskset.ocean_prefill_setpieces["kraken"] = { count = GetModConfigData("kraken")}		
		
	
	taskset.ocean_population = {
	"OceanCoastalShore_SW",
	"OceanCoastal_SW", 
	"OceanSwell_SW",
	"OceanRough_SW",
	"OceanReef_SW",
...
table.insert(level.tasks, "task_underwatermagmafield")
table.insert(level.tasks, "task_underwaterwatercoral")
if GetModConfigData("Shipwrecked") ~= 5 or GetModConfigData("enableallprefabs") == true then table.insert(level.tasks, "UnderwaterExit1") end
if GetModConfigData("Hamlet") ~= 5 or GetModConfigData("kindofworld") == 5 or GetModConfigData("enableallprefabs") == true then table.insert(level.tasks, "UnderwaterExit2") end
end
...
if GetModConfigData("gorgeisland") == 1 then		
		...
		table.insert(taskset.tasks, "gorgeislandforest")
		table.insert(taskset.tasks, "gorgeislandchicken")	
end	
...
taskset.set_pieces = 
        {
			["ResurrectionStone"] = { count = 2, tasks={"Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff" } },
			["WormholeGrass"] = { count = 8, tasks={"Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff" } },
			["ligamundoham"] = { count = 1, tasks={"Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff"} },
			["ligamundosw"] = { count = 1, tasks={"Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff" } },
			["MooseNest"] = { count = 9, tasks={"Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff" } },
			["CaveEntrance"] = { count = 10, tasks={"Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff" } },		   			
			["Sculptures_5"] = { count = 1, tasks={"Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff" } },
       }
end
...
taskset.set_pieces = 
        {
			["ResurrectionStone"] = { count = 2, tasks={"Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff" } },
			["WormholeGrass"] = { count = 8, tasks={"Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff"} },
			["ligamundoham"] = { count = 1, tasks={"Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff"} },
			["ligamundosw"] = { count = 1, tasks={"Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff"} },
			["MooseNest"] = { count = 9, tasks={"Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff" } },
			["CaveEntrance"] = { count = 10, tasks={"Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff"} },	   		
			["Sculptures_5"] = { count = 1, tasks={"Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff"} },	   		
        }
end
...
taskset.set_pieces = 
        {
			["ResurrectionStone"] = { count = 2, tasks={"Make a pick", "Dig that rock", "Great Plains", "Squeltch", "Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk", "Lightning Bluff" } },
			["WormholeGrass"] = { count = 8, tasks={"Make a pick", "Dig that rock", "Great Plains", "Squeltch", "Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk", "Lightning Bluff" } },
			["ligamundoham"] = { count = 1, tasks={"Make a pick", "Dig that rock", "Great Plains", "Squeltch", "Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk", "Lightning Bluff"} },
...
if GetModConfigData("Moon") == 15 then			
taskset.set_pieces["MoonAltarRockGlass"] = { count = 1, tasks={"XMoonIsland_Mine"} }
taskset.set_pieces["MoonAltarRockIdol"] = { count = 1, tasks={"XMoonIsland_Mine"} }
taskset.set_pieces["MoonAltarRockSeed"] = { count = 1, tasks={"XMoonIsland_Mine"} }
taskset.set_pieces["BathbombedHotspring"] = {count = 1, tasks={"XMoonIsland_Baths"}}
taskset.set_pieces["MoonFissures"] = {count = 1, tasks={"XMoonIsland_Fissures","XMoonIsland_Mine","XMoonIsland_Forest"}}
end	

if GetModConfigData("Moon") == 20 then			
taskset.set_pieces["MoonAltarRockGlass"] = { count = 1, tasks={"MMoonIsland_Mine"}}
taskset.set_pieces["MoonAltarRockIdol"] = { count = 1, tasks={"MMoonIsland_Mine"}}
taskset.set_pieces["MoonAltarRockSeed"] = { count = 1, tasks={"MMoonIsland_Mine"}}
taskset.set_pieces["BathbombedHotspring"] = {count = 1, tasks={"MMoonIsland_Baths"}}
taskset.set_pieces["MoonFissures"] = {count = 1, tasks={"MMoonIsland_Fissures","MMoonIsland_Mine","MMoonIsland_Forest"}}
end		
...
taskset.set_pieces["lobby_exit"] = { count = 1, tasks={"Make a pick" }}
end
...
----------------------------
	...
	taskset.ocean_prefill_setpieces["wreck2"] = { count = GetModConfigData("shipgraveyard")}		
	taskset.ocean_prefill_setpieces["kraken"] = { count = GetModConfigData("kraken")}		
--	taskset.ocean_prefill_setpieces["quagmire_kitchen"] = { count = GetModConfigData("gorgecity")}	
