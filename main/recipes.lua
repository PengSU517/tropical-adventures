...
AddRecipe2("bottlelantern", { Ingredient("messagebottleempty1", 1), Ingredient("bioluminescence", 2) },
...
AddRecipe2("messagebottleempty1", { Ingredient("sand", 3) }, TECH.SCIENCE_TWO, {}, { "REFINE" })
...
AddRecipe2("gashat",
	{ Ingredient("coral", 2), Ingredient("messagebottleempty1", 2), Ingredient("jellyfish", 1) },
	TECH.SCIENCE_TWO, {}, { "CLOTHING" })
AddRecipe2("antidote",
...
AddRecipe2("armor_lifejacket",
	{ Ingredient("fabric", 2), Ingredient("vine", 2), Ingredient("messagebottleempty1", 2) },
	TECH.SEAFARING_TWO, {}, { "NAUTICAL" })
AddRecipe2("seatrap",
	{ Ingredient("palmleaf", 4), Ingredient("messagebottleempty1", 2),
		Ingredient("jellyfish", 1) }, TECH.SEAFARING_TWO, {}, { "NAUTICAL" })
AddRecipe2("porto_buoy",
	{ Ingredient("messagebottleempty1", 1), Ingredient("bamboo", 4),
