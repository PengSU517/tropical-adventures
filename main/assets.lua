...
local hamletinventory = {
	"accomplishment_shrine", "aerodynamichat", "algae", "alloy", "aloe", "aloe_cooked", "aloe_seeds", "ancient_remnant",
	"antchest", "antivenom", "antler", "antmaskhat", "antsuit", "armor_lifeJacket", "armor_metalplate", "armor_snakeskin",
	"armor_snakeskin_scaly", "armor_weevole", "armor_windbreaker", "armorcactus", "armorlimestone", "armorobsidian",
	"armorseashell", "armorvoidcloak", "armorvortexcloak", "armouredboat", "asparagussoup_yotp", "bag", "ballpein_hammer",
	"ballphinhouse", "bamboo", "bananas", "bananas_cooked", "bandithat", "banditmap", "basefan", "bat_leather", "bathat",
	"bell1", "bill_quill", "bioluminescence", "bisque", "blowdart_flup", "blowdart_poison", "blubber", "blubbersuit",
	"blunderbuss", "blunderbuss_loaded", "boat_lantern", "boat_lantern_off", "boat_torch", "boat_torch_off", "boatcannon",
	"boatrepairkit", "bonestaff", "book_meteor", "bottlelantern", "bottlelantern_off", "brainjellyhat", "bramble_bulb",
	"bucket", "bugrepellent", "buoy", "burr", "butterfly_tropical", "butterflymuffin_sw", "butterflywings_tropical",
	"candlehat", "captainhat", "cargoboat", "caviar", "chiminea", "chitin", "city_hammer", "city_lamp",
	"clawpalmtree_sapling", "clippings", "clothes", "clothsail", "coconade", "coconut", "coconut_cooked",
	"coconut_halved", "coffee", "coffeebeans", "coffeebeans_cooked", "coi", "coi_cooked", "conch", "construction_permit",
	"coral", "coral_brain", "corallarve", "cork", "cork_bat", "corkboatitem", "corkchest", "cormorant", "cost-1",
	"cost-10", "cost-100", "cost-2", "cost-20", "cost-200", "cost-3", "cost-30", "cost-300", "cost-4", "cost-40",
	"cost-400", "cost-5", "cost-50", "cost-500", "cost-nil", "crab", "crabbit_beardling", "curtain_door",
	"cutgrass_green", "cutlass", "cutnettle", "dead_swordfish", "deed", "demolition_permit", "disarming_kit",
	"disguisehat", "dorsalfin", "double_umbrellahat", "doydoy", "doydoy_baby", "doydoy_teen", "doydoyegg",
	"doydoyegg_cooked", "doydoyfeather", "doydoynest", "dragonpie_yotp", "dragoonden", "dragoonheart", "dubloon",
	"dug_bambooTree", "dug_bush_vine", "dug_cactus", "dug_coffeebush", "dug_elephantcactus", "dug_grass_green",
	"dug_nettle", "earring", "encrustedboat", "eyebrella", "fabric", "feather_thunder", "feathersail", "feijoada",
	"feijoada_yotp", "fish3", "fish3_cooked", "fish4", "fish4_cooked", "fish5", "fish5_cooked", "fish_dogfish",
	"fish_farm", "fish_med_cooked", "fish_raw", "fish_raw_small", "fishtropical_cooked", "frogglebunwich_yotp",
	"froglegs_poison", "froglegs_poison_cooked", "gashat", "gasmaskhat", "glowfly", "gogglesarmorhat", "gogglesheathat",
	"gogglesnormalhat", "gogglesshoothat", "gold_dust", "goldenmachete", "goldpan", "gummy_cake", "gummy_cake_yotp",
	"hail_ice", "halberd", "hardshell_tacos", "hardshell_tacos_yotp", "harpoon", "hayfeverhat", "health_down",
	"health_max", "hippo_antler", "hogusporkusator", "honeyham_yotp", "honeynuggets_yotp", "icedtea", "icedtea_yotp",
	"icegem", "icemaker", "infused_iron", "interior_floor_check", "interior_floor_gardenstone",
	"interior_floor_geometrictiles", "interior_floor_herringbone", "interior_floor_hexagon", "interior_floor_hoof_curvy",
	"interior_floor_marble", "interior_floor_octagon", "interior_floor_plaid_tile", "interior_floor_shag_carpet",
	"interior_floor_sheet_metal", "interior_floor_transitional", "interior_floor_wood", "interior_floor_woodpanels",
	"interior_wall_checkered_metal", "interior_wall_circles", "interior_wall_floral", "interior_wall_fullwall_moulding",
	"interior_wall_harlequin", "interior_wall_marble", "interior_wall_mayorsoffice", "interior_wall_peagawk",
	"interior_wall_plain_rog", "interior_wall_rope", "interior_wall_sunflower", "interior_wall_upholstered",
	"interior_wall_wood", "iron", "iron_door", "ironwind", "jellyJerky", "jellybug", "jellybug_cooked", "jellyfish",
	"jellyfish_cooked", "jellyfish_dead", "jellyopop", "jungleTreeSeed", "key_to_city", "kingfisher", "limestone",
	"limpets", "limpets_cooked", "living_artifact", "lobster", "lobster_dead", "lobster_dead_cooked", "log_rainforest",
	"log_tropical", "lograft", "lotus_flower1", "lotus_flower1_cooked", "machete", "magic_seal", "magnifying_glass",
	"meatballs_yotp", "metalplatehat", "monkeyball", "monsterlasagna_yotp", "mosquito_yellow", "mosquitosack_yellow",
	"mussel", "mussel_bed", "mussel_cooked", "mussel_stick", "musselbouillabaise", "mysterymeat", "nectar_pod",
	"needlespear", "nettlelosange", "nettlelosange_yotp", "nubbin", "obsidian", "obsidianaxe", "obsidiancoconade",
	"obsidianfirepit", "obsidianmachete", "oinc", "oinc10", "oinc100", "organic_door", "ox_flute", "ox_horn", "oxhat",
	"packim_fishbone", "packim_fishbone_dead", "palmleaf", "palmleaf_hut", "palmleaf_umbrella", "parrot", "parrot_blue",
	"parrot_pirate", "peagawkfeather", "peagawkfeatherhat", "pedestal_key", "peg_leg", "perogies_yotp", "pheromonestone",
	...
	"plate_door", "player_house_brick", "player_house_brick_craft", "player_house_cottage", "player_house_cottage_craft",
	"player_house_gothic", "player_house_gothic_craft", "player_house_manor", "player_house_manor_craft",
	"player_house_tudor", "player_house_tudor_craft", "player_house_turret", "player_house_turret_craft",
	"player_house_villa", "player_house_villa_craft", "playerhouse_city", "poisonbalm", "pollen", "porkland_entrance",
	"primeapebarrel", "pugalisk_skull", "pumpkincookie_yotp", "quackenbeak", "quackendrill", "quackeringram",
	"rabid_beetle", "radish", "radish_cooked", "radish_seeds", "raft", "rainbowjellyfish", "rainbowjellyfish_cooked",
	"rainbowjellyfish_dead", "ratatouille_yotp", "rawling", "record_01", "record_02", "record_03", "relic_1", "relic_2",
	"relic_3", "relic_4", "relic_5", "reno_antiquities_beefalo", "reno_antiquities_wallfish", "reno_chair_bench",
	"reno_chair_chaise", "reno_chair_classic", "reno_chair_corner", "reno_chair_footrest", "reno_chair_horned",
	"reno_chair_lounge", "reno_chair_massager", "reno_chair_ottoman", "reno_chair_rocking", "reno_chair_stuffed",
	"reno_cornerbeam_marble", "reno_cornerbeam_millinery", "reno_cornerbeam_round", "reno_cornerbeam_wood",
	...
	"reno_plantholder_wip", "reno_plantholder_xerographica", "reno_plantholder_zz", "reno_rug_beard", "reno_rug_braid",
	"reno_rug_catcoon", "reno_rug_crime", "reno_rug_fur", "reno_rug_hedgehog", "reno_rug_hoofprint", "reno_rug_metal",
	"reno_rug_nailbed", "reno_rug_octagon", "reno_rug_oval", "reno_rug_porcupuss", "reno_rug_rectangle", "reno_rug_round",
	"reno_rug_rubbermat", "reno_rug_square", "reno_rug_swirl", "reno_rug_tiles", "reno_rug_web", "reno_rug_wormhole",
	"reno_shelves_adjustable", "reno_shelves_aframe", "reno_shelves_basic", "reno_shelves_cinderblocks",
	"reno_shelves_crates", "reno_shelves_floating", "reno_shelves_fridge", "reno_shelves_glass", "reno_shelves_hattree",
	"reno_shelves_hutch", "reno_shelves_industrial", "reno_shelves_ladder", "reno_shelves_marble",
	"reno_shelves_midcentury", "reno_shelves_pallet", "reno_shelves_pipe", "reno_shelves_wallmount", "reno_shelves_wood",
	"reno_tab_chairs", "reno_tab_columns", "reno_tab_doors", "reno_tab_floors", "reno_tab_hanginglamps",
	"reno_tab_homekits", "reno_tab_lamps", "reno_tab_ornaments", "reno_tab_plantholders", "reno_tab_rugs",
	"reno_tab_shelves", "reno_tab_tables", "reno_tab_wallpaper", "reno_tab_windows", "reno_table_banker",
	"reno_table_chess", "reno_table_crate", "reno_table_diy", "reno_table_raw", "reno_table_round",
	"reno_wallornament_axe", "reno_wallornament_black_cat", "reno_wallornament_cape", "reno_wallornament_embroidery_hoop",
	...
	"slugbug_cooked", "smelter", "snake", "snake_bone", "snake_scaly", "snakebonesoup", "snakebonesoup_yotp", "snakeoil",
	"snakeskin", "snakeskin_scaly", "snakeskinhat", "snakeskinhat_scaly", "snakeskinsail", "snakeskinsail_scaly",
	"spear_launcher", "spear_launcher_obsidian", "spear_launcher_poison", "spear_launcher_spear",
	"spear_launcher_wathgrithr", "spear_obsidian", "spear_poison", "spicyvegstinger", "spicyvegstinger_yotp",
	"sprinkler1", "steamedhamsandwich", "steamedhamsandwich_yotp", "stone_door", "stopwatch", "stuffedeggplant_yotp",
	"stunrod", "sunken_boat_trinket_1", "sunken_boat_trinket_2", "sunken_boat_trinket_3", "sunken_boat_trinket_4",
	"sunken_boat_trinket_5", "supertelescope", "surfboard_item", "sweet_potato", "sweet_potato_cooked",
	"sweet_potato_seeds", "sweetpotatosouffle", "tar", "tar_extractor", "tarlamp", "tarsuit", "tea", "tea_yotp",
	"teatree_nut", "teatree_nut_cooked", "telebrella", "teleportato_hamlet_base", "teleportato_hamlet_box",
	"teleportato_hamlet_crank", "teleportato_hamlet_potato", "teleportato_hamlet_ring", "teleportato_sw_base",
	"teleportato_sw_box", "teleportato_sw_crank", "teleportato_sw_potato", "teleportato_sw_ring", "telescope", "telipad",
	"thatchpack", "thorns_marsh", "thumper", "thunderhat", "tigereye", "toucan", "toucan_hamlet", "tracker",
	"tracker_open", "trawlnet", "waterdrop",
}
...
local volcanoinventory = {
	"aloe_oversized", "aloe_oversized_waxed", "antidote", "armor_seashell", "axeobsidian", "ballphinocean", "beaverskin",
	"bed0", "bed1", "bed2", "bed3", "bed4", "bed5", "bed6", "bed7", "bed8", "blueberries", "blueberries_cooked",
	"boarbattle", "boatmetal_item", "book_meteor1", "bossboarbattle", "bundled_structure", "butterfly_tropical_wings",
	"cottontree_cone", "dogfishocean", "doydoyfan", "fennel", "fennel_cooked", "fish2", "fish2_cooked", "fish6",
	"fish6_cooked", "fish7", "fish7_cooked", "fish_med", "fruityjuice", "glass_shards", "goldenbar", "goldfish",
	"gooseberry", "gooseberry_cooked", "hedge_block", "hedge_cone", "hedge_layered", "houndbattle", "knightbattle",
	"lizardbattle", "lobster_land", "lobsterunderwater", "lograft_old", "luckyhat", "malbatrossail", "maxwellphonograph",
	"maxwellstatuebracod", "maxwellstatuebracoe", "maxwellstatuecabeca", "maxwellstatuecorpo", "mecfish", "mermbattle",
	"messagebottle1", "messagebottleempty1", "mosquitopoison", "obsidianbomb", "oceanfish_small_10_inv",
	"oceanfish_small_11_inv", "oceanfish_small_12_inv", "oceanfish_small_13_inv", "oceanfish_small_14_inv",
	"oceanfish_small_15_inv", "oceanfish_small_16_inv", "oceanfish_small_17_inv", "oceanfish_small_18_inv",
	"oceanfish_small_19_inv", "oceanfish_small_20_inv", "oceanfish_small_21_inv", "oceanfish_small_61_inv",
	"oceanfish_small_71_inv", "oceanfish_small_81_inv", "oceanfish_small_91_inv", "ox_wool", "pandahouse", "pandaskin",
	"peagawkfeather_prism", "poop2", "porto", "porto_armouredboat", "porto_ballphinhouse", "porto_buoy",
	"porto_cargoboat", "porto_encrustedboat", "porto_fish_farm", "porto_lograft", "porto_lograft_old", "porto_raft",
	"porto_raft_old", "porto_researchlab5", "porto_rowboat", "porto_sea_chiminea", "porto_sea_yard", "porto_surfboard",
	"porto_tar_extractor", "porto_waterchest1", "porto_woodlegsboat", "radish_oversized", "radish_oversized_waxed",
	"raft_old", "rhinocebrosbattle", "salmon", "salmon_cooked", "sap", "sap_spoiled", "sapbucket", "seacucumber",
	"seacucumber_cooked", "seagullwater", "seataro", "seataro_cooked", "shadowmower_builder", "shard_beak", "shard_sword",
	"sharxocean", "snowitem", "spiderbattle", "spore_yellow", "stonebar", "surfboard", "surfboarditem", "swbait",
	"sweet_potato_oversized", "sweet_potato_oversized_waxed", "swineclopsbattle", "swordfishjocean", "swordfishjocean2",
	"tfwp_crystal_crown_hat", "tfwp_dragon_dart", "tfwp_fire_bomb", "tfwp_flower_headband_hat", "tfwp_healing_staff",
	"tfwp_lava_dart", "tfwp_lava_hammer", "tfwp_luxury_nox_helm_hat", "tfwp_spear_gung", "tfwp_spear_lance",
	"tfwp_summon_book", "tfwp_wizard_crown_hat", "tfwp_woven_garland_hat", "tree_forest_deep_seed",
	"tree_forest_rot_seed", "tree_forestseed", "trinket_giftshop_1", "trinket_giftshop_3", "trinket_giftshop_4",
	"tropical_fish", "tropicalbouillabaisse", "tuber_bloom_crop", "tuber_bloom_crop_cooked", "tuber_crop",
	"tuber_crop_cooked", "tunacan", "turbine_blades", "turf_ash", "turf_beach", "turf_checkeredlawn", "turf_cobbleroad",
	"turf_deeprainforest", "turf_fields", "turf_foundation", "turf_gasjungle", "turf_jungle", "turf_magmafield",
	"turf_meadow", "turf_pigruins", "turf_quagmire_parkfield", "turf_rainforest", "turf_snakeskinfloor", "turf_suburb",
	"turf_tidalmarsh", "turf_volcano", "turf_windy", "venomgland", "venus_stalk", "vine", "volcanostaff", "walkingstick",
	"wall_enforcedlimestone_item", "wall_limestone_item", "waterchest1", "watercress", "watercress_cooked",
	"weevole_carapace", "whaleblueocean", "wildbeaver_house", "wildborehouse", "wind_conch", "woodlegs_boatcannon",
	"woodlegs_key1", "woodlegs_key2", "woodlegs_key3", "woodlegsboat", "woodlegssail", "yelow_cap", "yelow_cap_cooked",
}
