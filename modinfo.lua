-----世界设置里的值只能是数字不能是字符串,所以modinfo最好保持同步
...
local options_enable = {
	...
	{ description = en_zh("Enabled", "开启"), data = 1 },
}
...
table_insert(configuration_options, isdev and Breaker("Developer Settings", "开发者选项") or nil)
