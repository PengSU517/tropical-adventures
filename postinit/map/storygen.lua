...
local troadv = TUNING.tropical
-------------以下代码可以直接改变主大陆但是 background room都不会生成
-- if ((troadv.shipwrecked and (troadv.startlocation == "shipwrecked")) or
--         (troadv.hamlet and (troadv.startlocation == "hamlet"))) and (not troadv.testmode) then
