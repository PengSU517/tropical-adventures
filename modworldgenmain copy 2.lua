...
if GetModConfigData("kindofworld") == 15 then
	...
	if GetModConfigData("kindofworld") == 10 then
		AddStartLocation("tropicalexperience", {
			...
			start_node = "DoyDoyM", --"MAINBeachPortalRoom",
		})
		...
		if GetModConfigData("startlocation") == 10 then
			AddStartLocation("tropicalexperience", {
				name = "tropicalexperience",
				location = "forest",
				start_setpeice = "DefaultStart", --"BeachStart",--改了之后还是会生成一片热带地形， 而且出生门是sw形状的 因为设置了taskset.valid_start_tasks
				start_node = "DoyDoyM", --  "MAINBeachPortalRoom",
			})
		end
		...
		local function TasksetPreInit(taskset)
			...
			if GetModConfigData("Together") == 10 then
				taskset.set_pieces =
				{
					["ResurrectionStone"] = { count = 2, tasks = { "Make a pick", "XDig that rock", "XGreat Plains",
						"XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands",
						"XFor a nice walk", "XLightning Bluff" } },
					["WormholeGrass"] = { count = 8, tasks = { "Make a pick", "XDig that rock", "XGreat Plains",
						"XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands",
						"XFor a nice walk", "XLightning Bluff" } },
					["ligamundoham"] = { count = 1, tasks = { "Make a pick", "XDig that rock", "XGreat Plains",
						"XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands",
						"XFor a nice walk", "XLightning Bluff" } },
					["ligamundosw"] = { count = 1, tasks = { "Make a pick", "XDig that rock", "XGreat Plains",
						"XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands",
						"XFor a nice walk", "XLightning Bluff" } },
					["MooseNest"] = { count = 9, tasks = { "Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch",
						"XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk",
						"XLightning Bluff" } },
					["CaveEntrance"] = { count = 10, tasks = { "Make a pick", "XDig that rock", "XGreat Plains",
						"XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands",
						"XFor a nice walk", "XLightning Bluff" } },
					["Sculptures_5"] = { count = 1, tasks = { "Make a pick", "XDig that rock", "XGreat Plains",
						"XSqueltch", "XBeeeees!", "XSpeak to the king", "XForest hunters", "XBadlands",
						"XFor a nice walk", "XLightning Bluff" } },
				}
			end
			...
			if GetModConfigData("Together") == 15 then
				taskset.set_pieces =
				{
					["ResurrectionStone"] = { count = 2, tasks = { "Make a pick", "MDig that rock", "MGreat Plains",
						"MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands",
						"MFor a nice walk", "MLightning Bluff" } },
					["WormholeGrass"] = { count = 8, tasks = { "Make a pick", "MDig that rock", "MGreat Plains",
						"MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands",
						"MFor a nice walk", "MLightning Bluff" } },
					["ligamundoham"] = { count = 1, tasks = { "Make a pick", "MDig that rock", "MGreat Plains",
						"MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands",
						"MFor a nice walk", "MLightning Bluff" } },
					["ligamundosw"] = { count = 1, tasks = { "Make a pick", "MDig that rock", "MGreat Plains",
						"MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands",
						"MFor a nice walk", "MLightning Bluff" } },
					["MooseNest"] = { count = 9, tasks = { "Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch",
						"MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk",
						"MLightning Bluff" } },
					["CaveEntrance"] = { count = 10, tasks = { "Make a pick", "MDig that rock", "MGreat Plains",
						"MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands",
						"MFor a nice walk", "MLightning Bluff" } },
					["Sculptures_5"] = { count = 1, tasks = { "Make a pick", "MDig that rock", "MGreat Plains",
						"MSqueltch", "MBeeeees!", "MSpeak to the king", "MForest hunters", "MBadlands",
						"MFor a nice walk", "MLightning Bluff" } },
				}
			end
			...
			if GetModConfigData("Together") == 20 then
				taskset.set_pieces =
				{
					["ResurrectionStone"] = { count = 2, tasks = { "Make a pick", "Dig that rock", "Great Plains",
						"Squeltch", "Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk",
						"Lightning Bluff" } },
					["WormholeGrass"] = { count = 8, tasks = { "Make a pick", "Dig that rock", "Great Plains",
						"Squeltch", "Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk",
						"Lightning Bluff" } },
					["ligamundoham"] = { count = 1, tasks = { "Make a pick", "Dig that rock", "Great Plains", "Squeltch",
						"Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk",
						"Lightning Bluff" } },
					["ligamundosw"] = { count = 1, tasks = { "Make a pick", "Dig that rock", "Great Plains", "Squeltch",
						"Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk",
						"Lightning Bluff" } },
					["MooseNest"] = { count = 9, tasks = { "Make a pick", "Dig that rock", "Great Plains", "Squeltch",
						"Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk",
						"Lightning Bluff" } },
					["CaveEntrance"] = { count = 10, tasks = { "Make a pick", "Dig that rock", "Great Plains",
						"Squeltch", "Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk",
						"Lightning Bluff" } },
					["Sculptures_5"] = { count = 1, tasks = { "Make a pick", "Dig that rock", "Great Plains", "Squeltch",
						"Beeeees!", "Speak to the king", "Forest hunters", "Badlands", "For a nice walk",
						"Lightning Bluff" } },
				}
			end
			...
			if GetModConfigData("Together") == 10 and GetModConfigData("tropicalshards") ~= 0 then
				taskset.set_pieces["sw_entrance"] = {
					...
					tasks = { "Make a pick", "XDig that rock", "XGreat Plains", "XSqueltch", "XBeeeees!",
						"XSpeak to the king", "XForest hunters", "XBadlands", "XFor a nice walk", "XLightning Bluff" }
				}
			...
			if GetModConfigData("Together") == 15 and GetModConfigData("tropicalshards") ~= 0 then
				taskset.set_pieces["sw_entrance"] = {
					...
					tasks = { "Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!",
						"MSpeak to the king", "MForest hunters", "MBadlands", "MFor a nice walk", "MLightning Bluff" }
				}
				taskset.set_pieces["hamlet_entrance"] = {
					count = 1,
					tasks = { "Make a pick", "MDig that rock", "MGreat Plains", "MSqueltch", "MBeeeees!",
			...
			if GetModConfigData("Shipwrecked") == 15 and GetModConfigData("tropicalshards") ~= 0 then
				taskset.set_pieces["sw_exit"] = {
					...
					tasks = { "TROPICAL6", "TROPICAL7", "TROPICAL8", "TROPICAL9", "TROPICAL11", "TROPICAL14",
						"TROPICAL15", "TROPICAL16", "TROPICAL17", "TROPICAL20", "TROPICAL26", "TROPICAL27", "TROPICAL28",
						"TROPICAL38", "TROPICAL39", "TROPICAL43", "TROPICAL45", "TROPICAL50", "TROPICAL51" }
				}
			end
			...
			if GetModConfigData("Shipwrecked") == 10 then
				taskset.set_pieces["ligamundoswexit"] = {
					count = 1,
					tasks = { "MISTO6", "MISTO7", "MISTO8", "MISTO9", "MISTO11", "MISTO14", "MISTO15", "MISTO16",
						"MISTO17", "MISTO20", "MISTO26", "MISTO27", "MISTO28", "MISTO38", "MISTO39", "MISTO43",
						"MISTO45", "MISTO50", "MISTO51" }
			...
			if GetModConfigData("Hamlet") == 20 and GetModConfigData("hamlet_caves") == 1 then
				...
				taskset.set_pieces["ligamundohamexit"] = {
					count = 1,
					tasks = { "Xplains", "Xplains_ruins", "XDeep_rainforest", "XDeep_rainforest_2", "Xpainted_sands",
						"XEdge_of_civilization", "XDeep_rainforest_mandrake", "Xrainforest_ruins",
						"XDeep_lost_ruins_gas", "XEdge_of_the_unknown_2" }
				}
			end
			...
			if GetModConfigData("Hamlet") == 15 and GetModConfigData("hamlet_caves") == 1 then
				...
				taskset.set_pieces["ligamundohamexit"] = {
					count = 1,
					tasks = { "plains", "plains_ruins", "Deep_rainforest", "Deep_rainforest_2", "painted_sands",
						"Edge_of_civilization", "Deep_rainforest_mandrake", "rainforest_ruins", "Deep_lost_ruins_gas",
			...
			if GetModConfigData("Hamlet") == 10 and GetModConfigData("hamlet_caves") == 1 then
				...
				taskset.set_pieces["ligamundohamexit"] = {
					count = 1,
					tasks = { "Mplains_ruins", "Mpainted_sands", "MEdge_of_civilization", "MDeep_rainforest_mandrake",
						"Mrainforest_ruins", "MEdge_of_the_unknown_2", "MDeep_rainforest_2" }
				}
			end
			----------------------------
