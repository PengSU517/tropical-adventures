...
if troadv.testmode then size = 100 end
...
if (troadv.together == "no_random") or (troadv.together == "bee_and_walrus") then
    AddLevelPreInitAny(function(level)
        if level.location == "cave" then
            ...
            -- for i, v in level.tasks do
            --     if v == "CaveExitTask8" or v == "CaveExitTask9" or v == "CaveExitTask10" then
            --         table.remove(level.tasks, i)
            --         print("remove!!!!!!!!!!!!!!!!!!")
            --     end
            -- end
            -- table.remove(level.tasks, "CaveExitTask8")--------这个代码不能直接用
            -- table.remove(level.tasks, "CaveExitTask9")
            -- table.remove(level.tasks, "CaveExitTask10")
        end
